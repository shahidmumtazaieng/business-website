#!/usr/bin/env python3
"""
Generator for /src/components/service-detail/tile-grout-cleaning-seo.tsx
...
The user brief (Tile & Grout Cleaning semantic SEO) was processed to:
  - Strip SEO-strategy language: "Topical Authority",
    "MaundyClean Semantic SEO Strategy", "Semantic Interlinking:",
    "[H1]/[H2]/[H3]", "[Button: ...]"
  - Strip source citations: none present in this brief
  - Strip competitor names: "Repair Restore Revive"
  ...
  - Add a near-me section + standalone near-me page (handled by the
    tile-grout-cleaning-near-me-page.tsx component, not this script)

Output: /home/z/my-project/src/components/service-detail/tile-grout-cleaning-seo.tsx
"""

from pathlib import Path

OUT_PATH = Path("/home/z/my-project/src/components/service-detail/tile-grout-cleaning-seo.tsx")
