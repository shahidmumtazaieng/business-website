#!/usr/bin/env python3
"""
Generator for /src/components/service-detail/pressure-washing-seo.tsx
...
The user brief (Pressure Washing & Exterior Cleaning semantic SEO) was
processed to:
  - Strip SEO-strategy language: "Topical Authority",
    "MaundyClean Semantic SEO Strategy", "Semantic Interlinking:",
    "[H1]/[H2]/[H3]", "[Button: ...]"
  - Strip source citations: [Precise Source], [314, Precise Source],
    [373, Precise Source], [315, Precise Source]
  - Strip competitor names: "Precise Pressure Washing Services",
    "Pressure Washing Direct"
  ...
  - Add a near-me section + standalone near-me page (handled by the
    pressure-washing-near-me-page.tsx component, not this script)

Output: /home/z/my-project/src/components/service-detail/pressure-washing-seo.tsx
"""

from pathlib import Path

OUT_PATH = Path("/home/z/my-project/src/components/service-detail/pressure-washing-seo.tsx")
