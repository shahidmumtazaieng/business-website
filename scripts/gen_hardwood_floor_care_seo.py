#!/usr/bin/env python3
"""
Generator for /src/components/service-detail/hardwood-floor-care-seo.tsx
...
The user brief (Hardwood Floor Care semantic SEO) was processed to:
  - Strip SEO-strategy language: "Topical Authority",
    "MaundyClean Semantic SEO Strategy", "Semantic Interlinking:",
    "[H1]/[H2]/[H3]", "[Button: ...]"
  - Strip source citations: [Competitor Source]
  ...
  - Convert bracketed link placeholders to real Next.js <Link> components:
      ...
      [Online Price Calculator]    -> /quote
"""

import os
from pathlib import Path

OUT = Path("/home/z/my-project/src/components/service-detail/hardwood-floor-care-seo.tsx")
