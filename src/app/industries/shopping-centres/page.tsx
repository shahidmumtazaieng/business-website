...
import { shoppingCentres } from "@/lib/industry-detail-data";

export const metadata: Metadata = {
  title: shoppingCentres.metaTitle,
  description: shoppingCentres.metaDescription,
  keywords: [
    "shopping-centres cleaning Scotland",
    "sector-led cleaning",
    "PVG-checked crews",
    "compliance audit-ready",
    "Scottish shopping-centres",
    "Maundy Clean shopping-centres",
  ],
  openGraph: {
    title: shoppingCentres.metaTitle,
    description: shoppingCentres.metaDescription,
    type: "website",
    images: [{ url: shoppingCentres.heroImage }],
  },
  alternates: { canonical: `/industries/shopping-centres` },
};

export default function ShoppingCentresPage() {
  const industry = shoppingCentres;
  return (
