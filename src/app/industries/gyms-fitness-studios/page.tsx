...
import { gymsFitnessStudios } from "@/lib/industry-detail-data";

export const metadata: Metadata = {
  title: gymsFitnessStudios.metaTitle,
  description: gymsFitnessStudios.metaDescription,
  keywords: [
    "gyms-fitness-studios cleaning Scotland",
    "sector-led cleaning",
    "PVG-checked crews",
    "compliance audit-ready",
    "Scottish gyms-fitness-studios",
    "Maundy Clean gyms-fitness-studios",
  ],
  openGraph: {
    title: gymsFitnessStudios.metaTitle,
    description: gymsFitnessStudios.metaDescription,
    type: "website",
    images: [{ url: gymsFitnessStudios.heroImage }],
  },
  alternates: { canonical: `/industries/gyms-fitness-studios` },
};

export default function GymsFitnessStudiosPage() {
  const industry = gymsFitnessStudios;
  return (
