...
import { hospitalsNhsTrusts } from "@/lib/industry-detail-data";

export const metadata: Metadata = {
  title: hospitalsNhsTrusts.metaTitle,
  description: hospitalsNhsTrusts.metaDescription,
  keywords: [
    "hospitals-nhs-trusts cleaning Scotland",
    "sector-led cleaning",
    "PVG-checked crews",
    "compliance audit-ready",
    "Scottish hospitals-nhs-trusts",
    "Maundy Clean hospitals-nhs-trusts",
  ],
  openGraph: {
    title: hospitalsNhsTrusts.metaTitle,
    description: hospitalsNhsTrusts.metaDescription,
    type: "website",
    images: [{ url: hospitalsNhsTrusts.heroImage }],
  },
  alternates: { canonical: `/industries/hospitals-nhs-trusts` },
};

export default function HospitalsNhsTrustsPage() {
  const industry = hospitalsNhsTrusts;
  return (
