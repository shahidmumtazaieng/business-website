...
import { veterinaryPractices } from "@/lib/industry-detail-data";

export const metadata: Metadata = {
  title: veterinaryPractices.metaTitle,
  description: veterinaryPractices.metaDescription,
  keywords: [
    "veterinary-practices cleaning Scotland",
    "sector-led cleaning",
    "PVG-checked crews",
    "compliance audit-ready",
    "Scottish veterinary-practices",
    "Maundy Clean veterinary-practices",
  ],
  openGraph: {
    title: veterinaryPractices.metaTitle,
    description: veterinaryPractices.metaDescription,
    type: "website",
    images: [{ url: veterinaryPractices.heroImage }],
  },
  alternates: { canonical: `/industries/veterinary-practices` },
};

export default function VeterinaryPracticesPage() {
  const industry = veterinaryPractices;
  return (
