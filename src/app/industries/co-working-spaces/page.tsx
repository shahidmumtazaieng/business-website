...
import { coWorkingSpaces } from "@/lib/industry-detail-data";

export const metadata: Metadata = {
  title: coWorkingSpaces.metaTitle,
  description: coWorkingSpaces.metaDescription,
  keywords: [
    "co-working-spaces cleaning Scotland",
    "sector-led cleaning",
    "PVG-checked crews",
    "compliance audit-ready",
    "Scottish co-working-spaces",
    "Maundy Clean co-working-spaces",
  ],
  openGraph: {
    title: coWorkingSpaces.metaTitle,
    description: coWorkingSpaces.metaDescription,
    type: "website",
    images: [{ url: coWorkingSpaces.heroImage }],
  },
  alternates: { canonical: `/industries/co-working-spaces` },
};

export default function CoWorkingSpacesPage() {
  const industry = coWorkingSpaces;
  return (
