...
import { faithBasedFacilities } from "@/lib/industry-detail-data";

export const metadata: Metadata = {
  title: faithBasedFacilities.metaTitle,
  description: faithBasedFacilities.metaDescription,
  keywords: [
    "faith-based-facilities cleaning Scotland",
    "sector-led cleaning",
    "PVG-checked crews",
    "compliance audit-ready",
    "Scottish faith-based-facilities",
    "Maundy Clean faith-based-facilities",
  ],
  openGraph: {
    title: faithBasedFacilities.metaTitle,
    description: faithBasedFacilities.metaDescription,
    type: "website",
    images: [{ url: faithBasedFacilities.heroImage }],
  },
  alternates: { canonical: `/industries/faith-based-facilities` },
};

export default function FaithBasedFacilitiesPage() {
  const industry = faithBasedFacilities;
  return (
