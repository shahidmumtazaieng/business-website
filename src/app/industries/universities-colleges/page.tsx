...
import { universitiesColleges } from "@/lib/industry-detail-data";

export const metadata: Metadata = {
  title: universitiesColleges.metaTitle,
  description: universitiesColleges.metaDescription,
  keywords: [
    "universities-colleges cleaning Scotland",
    "sector-led cleaning",
    "PVG-checked crews",
    "compliance audit-ready",
    "Scottish universities-colleges",
    "Maundy Clean universities-colleges",
  ],
  openGraph: {
    title: universitiesColleges.metaTitle,
    description: universitiesColleges.metaDescription,
    type: "website",
    images: [{ url: universitiesColleges.heroImage }],
  },
  alternates: { canonical: `/industries/universities-colleges` },
};

export default function UniversitiesCollegesPage() {
  const industry = universitiesColleges;
  return (
