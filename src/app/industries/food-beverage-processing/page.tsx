...
import { foodBeverageProcessing } from "@/lib/industry-detail-data";

export const metadata: Metadata = {
  title: foodBeverageProcessing.metaTitle,
  description: foodBeverageProcessing.metaDescription,
  keywords: [
    "food-beverage-processing cleaning Scotland",
    "sector-led cleaning",
    "PVG-checked crews",
    "compliance audit-ready",
    "Scottish food-beverage-processing",
    "Maundy Clean food-beverage-processing",
  ],
  openGraph: {
    title: foodBeverageProcessing.metaTitle,
    description: foodBeverageProcessing.metaDescription,
    type: "website",
    images: [{ url: foodBeverageProcessing.heroImage }],
  },
  alternates: { canonical: `/industries/food-beverage-processing` },
};

export default function FoodBeverageProcessingPage() {
  const industry = foodBeverageProcessing;
  return (
