...
import { gpSurgeriesClinics } from "@/lib/industry-detail-data";

export const metadata: Metadata = {
  title: gpSurgeriesClinics.metaTitle,
  description: gpSurgeriesClinics.metaDescription,
  keywords: [
    "gp-surgeries-clinics cleaning Scotland",
    "sector-led cleaning",
    "PVG-checked crews",
    "compliance audit-ready",
    "Scottish gp-surgeries-clinics",
    "Maundy Clean gp-surgeries-clinics",
  ],
  openGraph: {
    title: gpSurgeriesClinics.metaTitle,
    description: gpSurgeriesClinics.metaDescription,
    type: "website",
    images: [{ url: gpSurgeriesClinics.heroImage }],
  },
  alternates: { canonical: `/industries/gp-surgeries-clinics` },
};

export default function GpSurgeriesClinicsPage() {
  const industry = gpSurgeriesClinics;
  return (
