...
import { hotelsResorts } from "@/lib/industry-detail-data";

export const metadata: Metadata = {
  title: hotelsResorts.metaTitle,
  description: hotelsResorts.metaDescription,
  keywords: [
    "hotels-resorts cleaning Scotland",
    "sector-led cleaning",
    "PVG-checked crews",
    "compliance audit-ready",
    "Scottish hotels-resorts",
    "Maundy Clean hotels-resorts",
  ],
  openGraph: {
    title: hotelsResorts.metaTitle,
    description: hotelsResorts.metaDescription,
    type: "website",
    images: [{ url: hotelsResorts.heroImage }],
  },
  alternates: { canonical: `/industries/hotels-resorts` },
};

export default function HotelsResortsPage() {
  const industry = hotelsResorts;
  return (
