...
import { corporateOffices } from "@/lib/industry-detail-data";

export const metadata: Metadata = {
  title: corporateOffices.metaTitle,
  description: corporateOffices.metaDescription,
  keywords: [
    "corporate-offices cleaning Scotland",
    "sector-led cleaning",
    "PVG-checked crews",
    "compliance audit-ready",
    "Scottish corporate-offices",
    "Maundy Clean corporate-offices",
  ],
  openGraph: {
    title: corporateOffices.metaTitle,
    description: corporateOffices.metaDescription,
    type: "website",
    images: [{ url: corporateOffices.heroImage }],
  },
  alternates: { canonical: `/industries/corporate-offices` },
};

export default function CorporateOfficesPage() {
  const industry = corporateOffices;
  return (
