...
import { autoDealerships } from "@/lib/industry-detail-data";

export const metadata: Metadata = {
  title: autoDealerships.metaTitle,
  description: autoDealerships.metaDescription,
  keywords: [
    "auto-dealerships cleaning Scotland",
    "sector-led cleaning",
    "PVG-checked crews",
    "compliance audit-ready",
    "Scottish auto-dealerships",
    "Maundy Clean auto-dealerships",
  ],
  openGraph: {
    title: autoDealerships.metaTitle,
    description: autoDealerships.metaDescription,
    type: "website",
    images: [{ url: autoDealerships.heroImage }],
  },
  alternates: { canonical: `/industries/auto-dealerships` },
};

export default function AutoDealershipsPage() {
  const industry = autoDealerships;
  return (
