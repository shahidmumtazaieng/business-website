...
import { propertyManagementFirms } from "@/lib/industry-detail-data";

export const metadata: Metadata = {
  title: propertyManagementFirms.metaTitle,
  description: propertyManagementFirms.metaDescription,
  keywords: [
    "property-management-firms cleaning Scotland",
    "sector-led cleaning",
    "PVG-checked crews",
    "compliance audit-ready",
    "Scottish property-management-firms",
    "Maundy Clean property-management-firms",
  ],
  openGraph: {
    title: propertyManagementFirms.metaTitle,
    description: propertyManagementFirms.metaDescription,
    type: "website",
    images: [{ url: propertyManagementFirms.heroImage }],
  },
  alternates: { canonical: `/industries/property-management-firms` },
};

export default function PropertyManagementFirmsPage() {
  const industry = propertyManagementFirms;
  return (
