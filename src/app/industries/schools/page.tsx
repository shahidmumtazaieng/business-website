...
import { schools } from "@/lib/industry-detail-data";

export const metadata: Metadata = {
  title: schools.metaTitle,
  description: schools.metaDescription,
  keywords: [
    "schools cleaning Scotland",
    "sector-led cleaning",
    "PVG-checked crews",
    "compliance audit-ready",
    "Scottish schools",
    "Maundy Clean schools",
  ],
  openGraph: {
    title: schools.metaTitle,
    description: schools.metaDescription,
    type: "website",
    images: [{ url: schools.heroImage }],
  },
  alternates: { canonical: `/industries/schools` },
};

export default function SchoolsPage() {
  const industry = schools;
  return (
