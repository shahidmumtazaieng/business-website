...
import { banchory } from "@/lib/location-detail-data";

export const metadata: Metadata = {
  title: banchory.metaTitle,
  description: banchory.metaDescription,
  keywords: [
    "cleaning services Banchory",
    "Banchory cleaners",
    "house cleaning Banchory",
    "commercial cleaning Banchory",
    "deep clean Banchory",
    "move out cleaning Banchory",
    "PVG-checked cleaners Banchory",
    "recurring cleaning Banchory",
    "holiday let cleaning Banchory",
    "Maundy Clean Banchory",
  ],
  openGraph: {
    title: banchory.metaTitle,
    description: banchory.metaDescription,
    type: "website",
    images: [{ url: banchory.heroImage }],
  },
  alternates: { canonical: `/locations/banchory` },
};

export default function BanchoryPage() {
  const location = banchory;
  return (
