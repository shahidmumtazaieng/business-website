...
import { milngavie } from "@/lib/location-detail-data";

export const metadata: Metadata = {
  title: milngavie.metaTitle,
  description: milngavie.metaDescription,
  keywords: [
    "cleaning services Milngavie",
    "Milngavie cleaners",
    "house cleaning Milngavie",
    "commercial cleaning Milngavie",
    "deep clean Milngavie",
    "move out cleaning Milngavie",
    "PVG-checked cleaners Milngavie",
    "recurring cleaning Milngavie",
    "holiday let cleaning Milngavie",
    "Maundy Clean Milngavie",
  ],
  openGraph: {
    title: milngavie.metaTitle,
    description: milngavie.metaDescription,
    type: "website",
    images: [{ url: milngavie.heroImage }],
  },
  alternates: { canonical: `/locations/milngavie` },
};

export default function MilngaviePage() {
  const location = milngavie;
  return (
