...
import { dunfermline } from "@/lib/location-detail-data";
...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "Dunfermline cleaners",
    "house cleaning Dunfermline",
    "commercial cleaning Dunfermline",
    "deep clean Dunfermline",
    "move out cleaning Dunfermline",
    "PVG-checked cleaners Dunfermline",
    "recurring cleaning Dunfermline",
    "holiday let cleaning Dunfermline",
    "Maundy Clean Dunfermline",
  ],
  openGraph: {
    title: dunfermline.metaTitle,
    description: dunfermline.metaDescription,
    type: "website",
    images: [{ url: dunfermline.heroImage }],
  },
  alternates: { canonical: `/locations/dunfermline` },
};

export default function DunfermlinePage() {
  const location = dunfermline;
  return (
