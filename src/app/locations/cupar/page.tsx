...
import { cupar } from "@/lib/location-detail-data";

export const metadata: Metadata = {
  title: cupar.metaTitle,
  description: cupar.metaDescription,
  keywords: [
    "cleaning services Cupar",
    "Cupar cleaners",
    "house cleaning Cupar",
    "commercial cleaning Cupar",
    "deep clean Cupar",
    "move out cleaning Cupar",
    "PVG-checked cleaners Cupar",
    "recurring cleaning Cupar",
    "holiday let cleaning Cupar",
    "Maundy Clean Cupar",
  ],
  openGraph: {
    title: cupar.metaTitle,
    description: cupar.metaDescription,
    type: "website",
    images: [{ url: cupar.heroImage }],
  },
  alternates: { canonical: `/locations/cupar` },
};

export default function CuparPage() {
  const location = cupar;
  return (
