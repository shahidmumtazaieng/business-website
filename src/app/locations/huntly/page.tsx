...
import { huntly } from "@/lib/location-detail-data";

export const metadata: Metadata = {
  title: huntly.metaTitle,
  description: huntly.metaDescription,
  keywords: [
    "cleaning services Huntly",
    "Huntly cleaners",
    "house cleaning Huntly",
    "commercial cleaning Huntly",
    "deep clean Huntly",
    "move out cleaning Huntly",
    "PVG-checked cleaners Huntly",
    "recurring cleaning Huntly",
    "holiday let cleaning Huntly",
    "Maundy Clean Huntly",
  ],
  openGraph: {
    title: huntly.metaTitle,
    description: huntly.metaDescription,
    type: "website",
    images: [{ url: huntly.heroImage }],
  },
  alternates: { canonical: `/locations/huntly` },
};

export default function HuntlyPage() {
  const location = huntly;
  return (
