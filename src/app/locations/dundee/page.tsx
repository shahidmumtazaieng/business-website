...
import { dundee } from "@/lib/location-detail-data";

export const metadata: Metadata = {
  title: dundee.metaTitle,
  description: dundee.metaDescription,
  keywords: [
    "cleaning services Dundee",
    "Dundee cleaners",
    "house cleaning Dundee",
    "commercial cleaning Dundee",
    "deep clean Dundee",
    "move out cleaning Dundee",
    "PVG-checked cleaners Dundee",
    "recurring cleaning Dundee",
    "holiday let cleaning Dundee",
    "Maundy Clean Dundee",
  ],
  openGraph: {
    title: dundee.metaTitle,
    description: dundee.metaDescription,
    type: "website",
    images: [{ url: dundee.heroImage }],
  },
  alternates: { canonical: `/locations/dundee` },
};

export default function DundeePage() {
  const location = dundee;
  return (
