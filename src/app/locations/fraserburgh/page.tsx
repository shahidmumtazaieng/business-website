...
import { fraserburgh } from "@/lib/location-detail-data";

export const metadata: Metadata = {
  title: fraserburgh.metaTitle,
  description: fraserburgh.metaDescription,
  keywords: [
    "cleaning services Fraserburgh",
    "Fraserburgh cleaners",
    "house cleaning Fraserburgh",
    "commercial cleaning Fraserburgh",
    "deep clean Fraserburgh",
    "move out cleaning Fraserburgh",
    "PVG-checked cleaners Fraserburgh",
    "recurring cleaning Fraserburgh",
    "holiday let cleaning Fraserburgh",
    "Maundy Clean Fraserburgh",
  ],
  openGraph: {
    title: fraserburgh.metaTitle,
    description: fraserburgh.metaDescription,
    type: "website",
    images: [{ url: fraserburgh.heroImage }],
  },
  alternates: { canonical: `/locations/fraserburgh` },
};

export default function FraserburghPage() {
  const location = fraserburgh;
  return (
