...
import { auchterarder } from "@/lib/location-detail-data";

export const metadata: Metadata = {
  title: auchterarder.metaTitle,
  description: auchterarder.metaDescription,
  keywords: [
    "cleaning services Auchterarder",
    "Auchterarder cleaners",
    "house cleaning Auchterarder",
    "commercial cleaning Auchterarder",
    "deep clean Auchterarder",
    "move out cleaning Auchterarder",
    "PVG-checked cleaners Auchterarder",
    "recurring cleaning Auchterarder",
    "holiday let cleaning Auchterarder",
    "Maundy Clean Auchterarder",
  ],
  openGraph: {
    title: auchterarder.metaTitle,
    description: auchterarder.metaDescription,
    type: "website",
    images: [{ url: auchterarder.heroImage }],
  },
  alternates: { canonical: `/locations/auchterarder` },
};

export default function AuchterarderPage() {
  const location = auchterarder;
  return (
