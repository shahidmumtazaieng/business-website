...
import { livingston } from "@/lib/location-detail-data";

export const metadata: Metadata = {
  title: livingston.metaTitle,
  description: livingston.metaDescription,
  keywords: [
    "cleaning services Livingston",
    "Livingston cleaners",
    "house cleaning Livingston",
    "commercial cleaning Livingston",
    "deep clean Livingston",
    "move out cleaning Livingston",
    "PVG-checked cleaners Livingston",
    "recurring cleaning Livingston",
    "holiday let cleaning Livingston",
    "Maundy Clean Livingston",
  ],
  openGraph: {
    title: livingston.metaTitle,
    description: livingston.metaDescription,
    type: "website",
    images: [{ url: livingston.heroImage }],
  },
  alternates: { canonical: `/locations/livingston` },
};
