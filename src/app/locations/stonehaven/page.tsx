...
import { stonehaven } from "@/lib/location-detail-data";

export const metadata: Metadata = {
  title: stonehaven.metaTitle,
  description: stonehaven.metaDescription,
  keywords: [
    "cleaning services Stonehaven",
    "Stonehaven cleaners",
    "house cleaning Stonehaven",
    "commercial cleaning Stonehaven",
    "deep clean Stonehaven",
    "move out cleaning Stonehaven",
    "PVG-checked cleaners Stonehaven",
    "recurring cleaning Stonehaven",
    "holiday let cleaning Stonehaven",
    "Maundy Clean Stonehaven",
  ],
  openGraph: {
    title: stonehaven.metaTitle,
    description: stonehaven.metaDescription,
    type: "website",
    images: [{ url: stonehaven.heroImage }],
  },
  alternates: { canonical: `/locations/stonehaven` },
};

export default function StonehavenPage() {
  const location = stonehaven;
  return (
