...
import { bathgate } from "@/lib/location-detail-data";

export const metadata: Metadata = {
  title: bathgate.metaTitle,
  description: bathgate.metaDescription,
  keywords: [
    "cleaning services Bathgate",
    "Bathgate cleaners",
    "house cleaning Bathgate",
    "commercial cleaning Bathgate",
    "deep clean Bathgate",
    "move out cleaning Bathgate",
    "PVG-checked cleaners Bathgate",
    "recurring cleaning Bathgate",
    "holiday let cleaning Bathgate",
    "Maundy Clean Bathgate",
  ],
  openGraph: {
    title: bathgate.metaTitle,
    description: bathgate.metaDescription,
    type: "website",
    images: [{ url: bathgate.heroImage }],
  },
  alternates: { canonical: `/locations/bathgate` },
};

export default function BathgatePage() {
  const location = bathgate;
  return (
