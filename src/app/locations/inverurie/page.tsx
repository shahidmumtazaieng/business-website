...
import { inverurie } from "@/lib/location-detail-data";

export const metadata: Metadata = {
  title: inverurie.metaTitle,
  description: inverurie.metaDescription,
  keywords: [
    "cleaning services Inverurie",
    "Inverurie cleaners",
    "house cleaning Inverurie",
    "commercial cleaning Inverurie",
    "deep clean Inverurie",
    "move out cleaning Inverurie",
    "PVG-checked cleaners Inverurie",
    "recurring cleaning Inverurie",
    "holiday let cleaning Inverurie",
    "Maundy Clean Inverurie",
  ],
  openGraph: {
    title: inverurie.metaTitle,
    description: inverurie.metaDescription,
    type: "website",
    images: [{ url: inverurie.heroImage }],
  },
  alternates: { canonical: `/locations/inverurie` },
};

export default function InveruriePage() {
  const location = inverurie;
  return (
