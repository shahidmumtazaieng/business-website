...
import { prestwick } from "@/lib/location-detail-data";

export const metadata: Metadata = {
  title: prestwick.metaTitle,
  description: prestwick.metaDescription,
  keywords: [
    "cleaning services Prestwick",
    "Prestwick cleaners",
    "house cleaning Prestwick",
    "commercial cleaning Prestwick",
    "deep clean Prestwick",
    "move out cleaning Prestwick",
    "PVG-checked cleaners Prestwick",
    "recurring cleaning Prestwick",
    "holiday let cleaning Prestwick",
    "Maundy Clean Prestwick",
  ],
  openGraph: {
    title: prestwick.metaTitle,
    description: prestwick.metaDescription,
    type: "website",
    images: [{ url: prestwick.heroImage }],
  },
  alternates: { canonical: `/locations/prestwick` },
};

export default function PrestwickPage() {
  const location = prestwick;
  return (
