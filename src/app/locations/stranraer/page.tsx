...
import { stranraer } from "@/lib/location-detail-data";

export const metadata: Metadata = {
  title: stranraer.metaTitle,
  description: stranraer.metaDescription,
  keywords: [
    "cleaning services Stranraer",
    "Stranraer cleaners",
    "house cleaning Stranraer",
    "commercial cleaning Stranraer",
    "deep clean Stranraer",
    "move out cleaning Stranraer",
    "PVG-checked cleaners Stranraer",
    "recurring cleaning Stranraer",
    "holiday let cleaning Stranraer",
    "Maundy Clean Stranraer",
  ],
  openGraph: {
    title: stranraer.metaTitle,
    description: stranraer.metaDescription,
    type: "website",
    images: [{ url: stranraer.heroImage }],
  },
  alternates: { canonical: `/locations/stranraer` },
};

export default function StranraerPage() {
  const location = stranraer;
  return (
