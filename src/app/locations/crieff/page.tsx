...
import { crieff } from "@/lib/location-detail-data";

export const metadata: Metadata = {
  title: crieff.metaTitle,
  description: crieff.metaDescription,
  keywords: [
    "cleaning services Crieff",
    "Crieff cleaners",
    "house cleaning Crieff",
    "commercial cleaning Crieff",
    "deep clean Crieff",
    "move out cleaning Crieff",
    "PVG-checked cleaners Crieff",
    "recurring cleaning Crieff",
    "holiday let cleaning Crieff",
    "Maundy Clean Crieff",
  ],
  openGraph: {
    title: crieff.metaTitle,
    description: crieff.metaDescription,
    type: "website",
    images: [{ url: crieff.heroImage }],
  },
  alternates: { canonical: `/locations/crieff` },
};

export default function CrieffPage() {
  const location = crieff;
  return (
