...
import { hawick } from "@/lib/location-detail-data";

export const metadata: Metadata = {
  title: hawick.metaTitle,
  description: hawick.metaDescription,
  keywords: [
    "cleaning services Hawick",
    "Hawick cleaners",
    "house cleaning Hawick",
    "commercial cleaning Hawick",
    "deep clean Hawick",
    "move out cleaning Hawick",
    "PVG-checked cleaners Hawick",
    "recurring cleaning Hawick",
    "holiday let cleaning Hawick",
    "Maundy Clean Hawick",
  ],
  openGraph: {
    title: hawick.metaTitle,
    description: hawick.metaDescription,
    type: "website",
    images: [{ url: hawick.heroImage }],
  },
  alternates: { canonical: `/locations/hawick` },
};

export default function HawickPage() {
  const location = hawick;
  return (
