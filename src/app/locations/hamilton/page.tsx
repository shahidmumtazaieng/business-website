...
import { hamilton } from "@/lib/location-detail-data";
...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "deep clean Hamilton",
    "move out cleaning Hamilton",
    "PVG-checked cleaners Hamilton",
    "recurring cleaning Hamilton",
    "holiday let cleaning Hamilton",
    "Maundy Clean Hamilton",
  ],
  openGraph: {
    title: hamilton.metaTitle,
    description: hamilton.metaDescription,
    type: "website",
    images: [{ url: hamilton.heroImage }],
  },
