...
import { dunbar } from "@/lib/location-detail-data";

export const metadata: Metadata = {
  title: dunbar.metaTitle,
  description: dunbar.metaDescription,
  keywords: [
    "cleaning services Dunbar",
    "Dunbar cleaners",
    "house cleaning Dunbar",
    "commercial cleaning Dunbar",
    "deep clean Dunbar",
    "move out cleaning Dunbar",
    "PVG-checked cleaners Dunbar",
    "recurring cleaning Dunbar",
    "holiday let cleaning Dunbar",
    "Maundy Clean Dunbar",
  ],
  openGraph: {
    title: dunbar.metaTitle,
    description: dunbar.metaDescription,
    type: "website",
    images: [{ url: dunbar.heroImage }],
  },
  alternates: { canonical: `/locations/dunbar` },
};

export default function DunbarPage() {
  const location = dunbar;
  return (
