...
import { paisley } from "@/lib/location-detail-data";

export const metadata: Metadata = {
  title: paisley.metaTitle,
  description: paisley.metaDescription,
  keywords: [
    "cleaning services Paisley",
    "Paisley cleaners",
    "house cleaning Paisley",
    "commercial cleaning Paisley",
    "deep clean Paisley",
    "move out cleaning Paisley",
    "PVG-checked cleaners Paisley",
    "recurring cleaning Paisley",
    "holiday let cleaning Paisley",
    "Maundy Clean Paisley",
  ],
  openGraph: {
    title: paisley.metaTitle,
    description: paisley.metaDescription,
    type: "website",
    images: [{ url: paisley.heroImage }],
  },
  alternates: { canonical: `/locations/paisley` },
};

export default function PaisleyPage() {
  const location = paisley;
  return (
