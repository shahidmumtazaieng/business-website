...
import { linlithgow } from "@/lib/location-detail-data";

export const metadata: Metadata = {
  title: linlithgow.metaTitle,
  description: linlithgow.metaDescription,
  keywords: [
    "cleaning services Linlithgow",
    "Linlithgow cleaners",
    "house cleaning Linlithgow",
    "commercial cleaning Linlithgow",
    "deep clean Linlithgow",
    "move out cleaning Linlithgow",
    "PVG-checked cleaners Linlithgow",
    "recurring cleaning Linlithgow",
    "holiday let cleaning Linlithgow",
    "Maundy Clean Linlithgow",
  ],
  openGraph: {
    title: linlithgow.metaTitle,
    description: linlithgow.metaDescription,
    type: "website",
    images: [{ url: linlithgow.heroImage }],
  },
  alternates: { canonical: `/locations/linlithgow` },
};

export default function LinlithgowPage() {
  const location = linlithgow;
  return (
