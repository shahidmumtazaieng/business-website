...
import { stornoway } from "@/lib/location-detail-data";

export const metadata: Metadata = {
  title: stornoway.metaTitle,
  description: stornoway.metaDescription,
  keywords: [
    "cleaning services Stornoway (Lewis)",
    "Stornoway (Lewis) cleaners",
    "house cleaning Stornoway (Lewis)",
    "commercial cleaning Stornoway (Lewis)",
    "deep clean Stornoway (Lewis)",
    "move out cleaning Stornoway (Lewis)",
    "PVG-checked cleaners Stornoway (Lewis)",
    "recurring cleaning Stornoway (Lewis)",
    "holiday let cleaning Stornoway (Lewis)",
    "Maundy Clean Stornoway (Lewis)",
  ],
  openGraph: {
    title: stornoway.metaTitle,
    description: stornoway.metaDescription,
    type: "website",
    images: [{ url: stornoway.heroImage }],
  },
  alternates: { canonical: `/locations/stornoway` },
};

export default function StornowayPage() {
  const location = stornoway;
  return (
