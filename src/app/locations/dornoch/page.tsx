...
import { dornoch } from "@/lib/location-detail-data";

export const metadata: Metadata = {
  title: dornoch.metaTitle,
  description: dornoch.metaDescription,
  keywords: [
    "cleaning services Dornoch",
    "Dornoch cleaners",
    "house cleaning Dornoch",
    "commercial cleaning Dornoch",
    "deep clean Dornoch",
    "move out cleaning Dornoch",
    "PVG-checked cleaners Dornoch",
    "recurring cleaning Dornoch",
    "holiday let cleaning Dornoch",
    "Maundy Clean Dornoch",
  ],
  openGraph: {
    title: dornoch.metaTitle,
    description: dornoch.metaDescription,
    type: "website",
    images: [{ url: dornoch.heroImage }],
  },
  alternates: { canonical: `/locations/dornoch` },
};

export default function DornochPage() {
  const location = dornoch;
  return (
