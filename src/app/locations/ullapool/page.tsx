...
import { ullapool } from "@/lib/location-detail-data";

export const metadata: Metadata = {
  title: ullapool.metaTitle,
  description: ullapool.metaDescription,
  keywords: [
    "cleaning services Ullapool",
    "Ullapool cleaners",
    "house cleaning Ullapool",
    "commercial cleaning Ullapool",
    "deep clean Ullapool",
    "move out cleaning Ullapool",
    "PVG-checked cleaners Ullapool",
    "recurring cleaning Ullapool",
    "holiday let cleaning Ullapool",
    "Maundy Clean Ullapool",
  ],
  openGraph: {
    title: ullapool.metaTitle,
    description: ullapool.metaDescription,
    type: "website",
    images: [{ url: ullapool.heroImage }],
  },
  alternates: { canonical: `/locations/ullapool` },
};

export default function UllapoolPage() {
  const location = ullapool;
  return (
