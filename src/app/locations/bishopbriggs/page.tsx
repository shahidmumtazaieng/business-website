...
import { bishopbriggs } from "@/lib/location-detail-data";

export const metadata: Metadata = {
  title: bishopbriggs.metaTitle,
  description: bishopbriggs.metaDescription,
  keywords: [
    "cleaning services Bishopbriggs",
    "Bishopbriggs cleaners",
    "house cleaning Bishopbriggs",
    "commercial cleaning Bishopbriggs",
    "deep clean Bishopbriggs",
    "move out cleaning Bishopbriggs",
    "PVG-checked cleaners Bishopbriggs",
    "recurring cleaning Bishopbriggs",
    "holiday let cleaning Bishopbriggs",
    "Maundy Clean Bishopbriggs",
  ],
  openGraph: {
    title: bishopbriggs.metaTitle,
    description: bishopbriggs.metaDescription,
    type: "website",
    images: [{ url: bishopbriggs.heroImage }],
  },
  alternates: { canonical: `/locations/bishopbriggs` },
};

export default function BishopbriggsPage() {
  const location = bishopbriggs;
  return (
