...
import { portree } from "@/lib/location-detail-data";

export const metadata: Metadata = {
  title: portree.metaTitle,
  description: portree.metaDescription,
  keywords: [
    "cleaning services Portree (Skye)",
    "Portree (Skye) cleaners",
    "house cleaning Portree (Skye)",
    "commercial cleaning Portree (Skye)",
    "deep clean Portree (Skye)",
    "move out cleaning Portree (Skye)",
    "PVG-checked cleaners Portree (Skye)",
    "recurring cleaning Portree (Skye)",
    "holiday let cleaning Portree (Skye)",
    "Maundy Clean Portree (Skye)",
  ],
  openGraph: {
    title: portree.metaTitle,
    description: portree.metaDescription,
    type: "website",
    images: [{ url: portree.heroImage }],
  },
  alternates: { canonical: `/locations/portree` },
};

export default function PortreePage() {
  const location = portree;
  return (
