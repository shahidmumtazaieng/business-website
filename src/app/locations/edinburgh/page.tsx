...
import { edinburgh } from "@/lib/location-detail-data";
...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "deep clean Edinburgh",
    "move out cleaning Edinburgh",
    "PVG-checked cleaners Edinburgh",
    "recurring cleaning Edinburgh",
    "holiday let cleaning Edinburgh",
    "Maundy Clean Edinburgh",
  ],
  openGraph: {
    title: edinburgh.metaTitle,
    description: edinburgh.metaDescription,
    type: "website",
    images: [{ url: edinburgh.heroImage }],
  },
  alternates: { canonical: `/locations/edinburgh` },
};
