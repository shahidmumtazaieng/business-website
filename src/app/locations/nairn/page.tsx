...
import { nairn } from "@/lib/location-detail-data";

export const metadata: Metadata = {
  title: nairn.metaTitle,
  description: nairn.metaDescription,
  keywords: [
    "cleaning services Nairn",
    "Nairn cleaners",
    "house cleaning Nairn",
    "commercial cleaning Nairn",
    "deep clean Nairn",
    "move out cleaning Nairn",
    "PVG-checked cleaners Nairn",
    "recurring cleaning Nairn",
    "holiday let cleaning Nairn",
    "Maundy Clean Nairn",
  ],
  openGraph: {
    title: nairn.metaTitle,
    description: nairn.metaDescription,
    type: "website",
    images: [{ url: nairn.heroImage }],
  },
  alternates: { canonical: `/locations/nairn` },
};

export default function NairnPage() {
  const location = nairn;
  return (
