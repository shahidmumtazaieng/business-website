...
import { peterhead } from "@/lib/location-detail-data";

export const metadata: Metadata = {
  title: peterhead.metaTitle,
  description: peterhead.metaDescription,
  keywords: [
    "cleaning services Peterhead",
    "Peterhead cleaners",
    "house cleaning Peterhead",
    "commercial cleaning Peterhead",
    "deep clean Peterhead",
    "move out cleaning Peterhead",
    "PVG-checked cleaners Peterhead",
    "recurring cleaning Peterhead",
    "holiday let cleaning Peterhead",
    "Maundy Clean Peterhead",
  ],
  openGraph: {
    title: peterhead.metaTitle,
    description: peterhead.metaDescription,
    type: "website",
    images: [{ url: peterhead.heroImage }],
  },
  alternates: { canonical: `/locations/peterhead` },
};

export default function PeterheadPage() {
  const location = peterhead;
  return (
