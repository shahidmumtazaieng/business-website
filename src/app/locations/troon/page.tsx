...
import { troon } from "@/lib/location-detail-data";

export const metadata: Metadata = {
  title: troon.metaTitle,
  description: troon.metaDescription,
  keywords: [
    "cleaning services Troon",
    "Troon cleaners",
    "house cleaning Troon",
    "commercial cleaning Troon",
    "deep clean Troon",
    "move out cleaning Troon",
    "PVG-checked cleaners Troon",
    "recurring cleaning Troon",
    "holiday let cleaning Troon",
    "Maundy Clean Troon",
  ],
  openGraph: {
    title: troon.metaTitle,
    description: troon.metaDescription,
    type: "website",
    images: [{ url: troon.heroImage }],
  },
  alternates: { canonical: `/locations/troon` },
};

export default function TroonPage() {
  const location = troon;
  return (
