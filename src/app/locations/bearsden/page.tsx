...
import { bearsden } from "@/lib/location-detail-data";

export const metadata: Metadata = {
  title: bearsden.metaTitle,
  description: bearsden.metaDescription,
  keywords: [
    "cleaning services Bearsden",
    "Bearsden cleaners",
    "house cleaning Bearsden",
    "commercial cleaning Bearsden",
    "deep clean Bearsden",
    "move out cleaning Bearsden",
    "PVG-checked cleaners Bearsden",
    "recurring cleaning Bearsden",
    "holiday let cleaning Bearsden",
    "Maundy Clean Bearsden",
  ],
  openGraph: {
    title: bearsden.metaTitle,
    description: bearsden.metaDescription,
    type: "website",
    images: [{ url: bearsden.heroImage }],
  },
  alternates: { canonical: `/locations/bearsden` },
};

export default function BearsdenPage() {
  const location = bearsden;
  return (
