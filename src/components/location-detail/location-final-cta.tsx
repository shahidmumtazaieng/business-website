...
import { ArrowRight, Phone, Shield, Clock, CheckCircle2, MapPin } from "lucide-react";
import { contactInfo } from "@/lib/site-data";
import type { LocationDetail } from "@/lib/location-detail-data";

export function LocationFinalCta({ location }: { location: LocationDetail }) {
  return (
          ...
          <div className="relative px-6 lg:px-12 py-12 lg:py-16 grid lg:grid-cols-[1.5fr_1fr] gap-10 items-center">
            <div>
              ...
              >
                ...
                Free quote in 60 seconds · {location.name} · No card required
              </motion.div>
              ...
              <h2 className="font-display font-extrabold text-3xl lg:text-5xl text-white leading-tight tracking-tight">
                ...
                <span className="text-[var(--gold)]">{location.name}?</span>
              </h2>

              <p className="mt-4 text-white/85 text-base lg:text-lg max-w-xl leading-relaxed">
                Get a personalised quote in under a minute. Flat-rate, locked-in pricing.
                A {location.name}-based, PVG-checked crew. Same team every visit. Cancel anytime.
              </p>
            ...
            >
              <div className="text-center mb-4">
                <div className="text-[10px] font-bold uppercase tracking-wider text-[var(--brand)] mb-1">
                  Your first clean in {location.name}
                </div>
              ...
              <ul className="space-y-2.5 text-sm">
                {[
                  ...
                  `${location.name} crew assigned & walk-through booked`,
