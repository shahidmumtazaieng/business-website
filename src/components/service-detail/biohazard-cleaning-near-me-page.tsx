...
const TRUST_PILLARS = [
  {
    icon: ShieldCheck,
    title: "Licensed Biohazard Technicians",
    text: "Maundy Clean is fully qualified and accredited in forensic, trauma, and hazardous material decontaminations. We never sub-contract or use unvetted labor.",
  },
  {
    icon: Users,
...
const NEAR_ME_FAQS = [
  {
    q: "How quickly can a biohazard cleaning crew respond?",
  ...
  {
    q: "Do your biohazard services cover domestic residences?",
    a: "Yes. We work extensively with private homeowners, tenants, local authorities, and housing associations to restore residential properties, tenement flats, and estate buildings back to complete biological safety.",
  },
  {
...
export function BiohazardCleaningNearMeHero() {
      ...
      <section className="relative min-h-[460px] flex items-center justify-center bg-[var(--brand-dark)] text-white overflow-hidden py-16">
        <div className="absolute inset-0 z-0">
          ...
          <img
            ...
            alt="Biohazard Cleaning Near Me"
        ...
        <div className="relative z-10 max-w-[1000px] mx-auto px-6 text-center space-y-6">
          ...
          <h1 className="font-display text-4xl sm:text-5xl font-extrabold leading-[1.1] tracking-tight">
            Biohazard & Trauma Decontamination Near Me in Scotland
          </h1>
          <p className="text-base sm:text-lg text-white/95 max-w-3xl mx-auto leading-relaxed font-medium">
            Find certified, discreet, and HSE-compliant biohazard cleaning and trauma scene decontamination crews in your local Scottish area. On-site within 2 hours across the Central Belt.
          </p>
      ...
      <section className="py-16 bg-[var(--cream)]">
        <div className="max-w-[1200px] mx-auto px-6 space-y-12">
          <div className="text-center max-w-3xl mx-auto space-y-4">
            ...
            <p className="text-sm text-[var(--muted-foreground)] leading-relaxed">
              Biological cleanup requires certified specialists. At Maundy Clean, our technical staff are rigorously trained and equipped for any sensitive environment.
            </p>
          </div>
        ...
        <div className="max-w-[1200px] mx-auto px-6 space-y-12">
          <div className="text-center max-w-3xl mx-auto space-y-4">
            ...
            <p className="text-sm text-[var(--muted-foreground)]">
              Restoring properties from trauma or biological risk involves sequential steps. Discover our adjacent cleaning programs.
            </p>
          </div>
      ...
      <section className="py-16 bg-[var(--brand-dark)] text-white text-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-[800px] mx-auto px-6 space-y-6">
          <h2 className="font-display text-3xl font-extrabold">
            Request Local Biohazard Dispatch Services
          </h2>
