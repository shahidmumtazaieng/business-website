...
const IMG = {
  heroWide:
    "https://maundyclean.sirv.com/Images/WhatsApp%20Image%202026-07-21%20at%209.27.56%20PM.jpeg",
  scotlandMap:
...
const HERO_BADGES = [
  ...
  { icon: Leaf, label: "HSE-Compliant Supplies" },
  { icon: Clock, label: "After-Hours & 7 Days a Week" },
];
...
const TRUST_PILLARS = [
  {
    icon: Building2,
    title: "Local Corporate Specialists, Not an Impersonal Agency",
    description:
      "Maundy Clean is a Scottish corporate facility cleaning company built on the Maundy tradition of service and care. We don&rsquo;t operate as an impersonal national agency &mdash; we&rsquo;re a local specialist with PVG-checked crews living and working in your area. Whether you&rsquo;re searching for nightly corporate cleaning in Glasgow&rsquo;s financial district, after-hours facility maintenance in Edinburgh&rsquo;s New Town, GDPR-aware cleaning for a legal firm in Aberdeen, or restaurant kitchen deep cleaning anywhere in between, we assign a vetted, PAYE-employed crew that stays with you for the long run. Same team, same standard, same locked-in rate for 12 months.",
  },
  {
    icon: Users,
    title: "The Same Trusted Crew Every Visit",
    description:
      "Unlike gig-economy cleaning apps, we only employ our own staff. The same vetted, uniformed, and PVG-checked crew that manages your first clean is the crew that returns for every scheduled session. Continuity matters when the stakes are sensitive data, expensive equipment, and a 100% re-clean guarantee &mdash; we don&rsquo;t send rotating crews of strangers to your workplace. When your regular crew lead is on annual leave, we send a trained backup who has been briefed on your site specifics and we tell you in advance.",
  },
  {
    icon: Shield,
    title: "PVG-Checked, GDPR-Aware & £10m Public Liability",
    description:
      "Every technician carries Disclosure Scotland PVG scheme membership, and we train them on GDPR-aware corporate cleaning: don&rsquo;t touch documents on desks, don&rsquo;t plug or unplug devices, don&rsquo;t photograph the space, don&rsquo;t discuss what you&rsquo;ve seen. All HSE-compliant chemicals come with COSHH datasheets on file, and we default to eco-labelled products with hospital-grade alternatives for medical or food-prep areas. We hold &pound;10m public liability cover (suitable for major corporate contracts, multi-tenant buildings, and business parks), &pound;5m employer&rsquo;s liability cover, and can provide enhanced background checks and additional NDAs for sensitive environments.",
  },
  {
    icon: Award,
    title: "Dedicated Account Manager & 100% Satisfaction Guarantee",
    description:
      "Every corporate client gets a dedicated account manager who knows your building, your team, your access protocols, and your priorities &mdash; direct mobile number, 24-hour response, quarterly on-site walk-throughs. We offer a free re-clean within 24 to 48 hours if you are not 100% satisfied, and our visit-completion rate in 2025 was 99.6%. From &pound;15 per hour for a Small Corporate facility through to a fully bespoke retainer for a multi-site corporate portfolio, the Maundy Clean standard applies on every visit. Audit-ready documentation (clean logs, COSHH, RAMS, training records, sustainability reports) is included as standard for ISO 14001, ISO 9001, and customer audits.",
  },
];
...
const BOOKING_STEPS = [
  {
    icon: ClipboardList,
    step: "01",
    title: "Free Site Survey & Proposal",
    description:
      "Contact us for a free, no-obligation site survey with our management team. We measure the space, identify priority zones, review access protocols, discuss timing windows, and capture your corporate brand standards &mdash; then send an itemised proposal within 2 business days: crew size, visit frequency, time on-site, scope of work, fixed monthly rate, and a draft cleaning schedule. No pushy sales call, no waiting 24 hours for a callback. The price you see is the price you pay &mdash; locked in for 12 months.",
  },
  {
    icon: UserCheck,
    step: "02",
    ...
    description:
      "We match you with a vetted, PVG-checked crew in your postcode. Your allocated crew lead is briefed on your site, GDPR-trained if you handle sensitive data, corporate-trained in brand standards and reception presentation, and introduced to your facilities or reception team on the first visit. The same crew returns for every scheduled session &mdash; building real knowledge of your facility&rsquo;s high-traffic zones, screen-sensitive surfaces, and access preferences.",
  },
  {
    icon: CalendarCheck,
    step: "03",
    title: "A Pristine Workplace, Every Visit",
    description:
      "Experience a workspace that looks, smells, and feels fresh, backed by our 100% satisfaction guarantee. You receive monthly cleaning logs showing every visit, arrival and departure times, tasks completed, and any issues flagged. Your dedicated account manager visits quarterly for a walk-through and proactively raises concerns before they become complaints. From &pound;15 per hour through to a fully bespoke multi-site corporate retainer.",
  },
];
...
const NEAR_ME_FAQS = [
  {
    ...
    a: "We cover 72+ towns and cities across Scotland &mdash; from Glasgow and Edinburgh in the Central Belt to Lerwick in Shetland and everywhere in between. Use the location grid above to find your town. If you don&rsquo;t see your postcode listed, call us &mdash; we add new corporate coverage areas every month and may already have a corporate facility cleaning crew near you.",
  },
  {
    q: "How quickly can a local corporate cleaning crew start?",
    a: "From site survey to first clean in 5-7 working days for most postcodes in the Central Belt. For more remote areas (Highlands, Islands, Borders), allow 7-10 working days for crew routing and travel planning. Same-week starts are occasionally possible in Glasgow, Edinburgh, Stirling, and Dundee &mdash; call us to check availability. Large multi-floor corporate contracts typically schedule 3-4 weeks out to allow for full site survey, proposal, mobilisation, and crew onboarding.",
  },
  {
    q: "Will the crew travel to my facility, or do I need to bring anything to you?",
    a: "All corporate facility cleaning is performed on-site at your premises &mdash; we never transport anything off-site. Our crews arrive in liveried vans with commercial-grade vacuums (Sebo BS36/BS46, Henry HVR200), microfibre flat-mop systems, colour-coded cloths (red for toilets, blue for sinks, green for kitchens, yellow for desks), HSE-compliant chemicals with COSHH datasheets, and PPE. You provide consumables &mdash; bin liners, paper towel, toilet paper, hand soap &mdash; or we can manage consumable restocking for an additional monthly fee.",
  },
  {
    q: "Do you have corporate cleaning crews available in rural Scotland?",
    a: "Yes. We cover rural Scotland including Perthshire, Angus, Fife, the Borders, Argyll, Aberdeenshire, and parts of the Highlands. For very remote corporate properties (Islands, far North), we may operate on a minimum-visit basis or schedule combined visits with neighbouring businesses to keep travel costs down. Call us to discuss your specific location &mdash; we&rsquo;ll always give you a straight answer on coverage and lead time.",
  },
  {
    q: "Can you handle secure access and alarm systems at my corporate facility?",
    a: "Absolutely. We&rsquo;re trained on all major alarm systems (Texecom, Honeywell, Pyronix, Risco) and follow strict key-handling protocols: keys stored in a coded safe between visits, alarm codes encrypted and only released to your assigned crew lead, never labelled with your address. We hold &pound;10m public liability cover and &pound;5m employer&rsquo;s liability cover &mdash; suitable for major corporate contracts, multi-tenant buildings, and business parks. For particularly sensitive sites (legal, financial, medical, government-adjacent), we can provide enhanced background checks and additional NDAs at no extra cost.",
  },
  {
    q: "What&rsquo;s the difference between daily, weekly, and after-hours corporate cleaning near me?",
    a: "Daily cleaning (typically Monday-Friday, after-hours 6pm-10pm) is the right choice for corporate facilities with 20+ desks, high client traffic, or food preparation areas &mdash; the cumulative soil load is too high for less frequent visits. Weekly cleaning suits small offices (5-15 desks) or low-traffic professional suites. After-hours cleaning means your crew works when your team isn&rsquo;t there &mdash; typically 6pm-10pm or 5am-7am &mdash; giving them the empty space they need to do a proper job without vacuuming around people on calls. We can also split: light touch during the day (day porter service), deep clean after hours. Your account manager will advise on the best schedule for your specific footprint and density.",
  },
];
...
export function CorporateFacilityCleaningNearMeHero() {
  return (
    <>
      {/* ============================================================ */}
      {/* SECTION 1 - Hero */}
      {/* H1: Corporate Facility Cleaning Near Me in Scotland */}
      {/* ============================================================ */}
      <section className="relative overflow-hidden">
        <div className="absolute inset-0">
          <img
            src={IMG.heroWide}
            alt="Maundy Clean uniformed corporate facility cleaning crew resetting a corporate HQ in Scotland after hours"
        ...
        <div className="relative max-w-[1400px] mx-auto px-6 py-20 lg:py-28">
          ...
          >
            ...
            >
              ...
              72+ Scottish towns &middot; PVG-checked corporate crews &middot; Same team every visit
            </motion.div>
            ...
            >
              Corporate Facility Cleaning Near Me in Scotland
            </motion.h1>
            ...
            >
              ...
              happens to be. From &pound;15 per hour for a Small Corporate facility through to a fully
              bespoke retainer for a multi-site corporate portfolio.
            </motion.p>
      ...
      {/* H2: Local Corporate Facility Cleaning You Can Trust */}
      {/* ============================================================ */}
        ...
        <div className="max-w-[1100px] mx-auto px-6">
          ...
          >
            <span className="text-xs font-bold uppercase tracking-[0.18em] text-[var(--brand)] mb-3 inline-block">
              Local corporate facility cleaning &middot; Scotland-wide
            </span>
            <h2 className="font-display font-extrabold text-3xl lg:text-5xl text-[var(--ink)] tracking-tight mb-5">
              Local Corporate Facility Cleaning You Can Trust
            </h2>
            <p className="text-base lg:text-lg text-[var(--ink)]/85 leading-[1.75]">
              ...
              &mdash; we&rsquo;re a local specialist with PVG-checked crews living and working in your
              area. Whether you&rsquo;re searching for nightly corporate cleaning in Glasgow&rsquo;s
              financial district, after-hours facility maintenance in Edinburgh&rsquo;s New Town,
              GDPR-aware cleaning for a legal firm in Aberdeen, or restaurant kitchen deep cleaning
              anywhere in between, we assign a vetted, PAYE-employed crew that stays with you for the
      ...
      {/* H2: Find Your Local Corporate Cleaning Crew */}
      {/* ============================================================ */}
          ...
          <div className="grid lg:grid-cols-[1fr_1.6fr] gap-10 lg:gap-14 items-start">
            ...
            >
              ...
              <h2 className="font-display font-extrabold text-3xl lg:text-5xl text-[var(--ink)] tracking-tight mb-4">
                Find Your Local Corporate Cleaning Crew
              </h2>
              <p className="text-base lg:text-lg text-[var(--muted-foreground)] leading-relaxed mb-6">
                Our network of vetted, PVG-checked corporate facility cleaning crews spans the entire
                country. From the Central Belt to the Highlands and Islands, we have a local team
                ready to care for your workplace. Browse by region below, or call us to confirm
              ...
              <div className="relative rounded-3xl overflow-hidden shadow-brand aspect-[4/3] bg-[var(--brand-dark)]">
                <img
                  src={IMG.scotlandMap}
                  alt="Map of Scotland showing Maundy Clean corporate facility cleaning coverage areas"
      ...
      {/* ============================================================ */}
      {/* SECTION 4 - Why Maundy Clean for your local corporate cleaning */}
      {/* H2: Why Scottish Businesses Choose Maundy Clean */}
      {/* ============================================================ */}
      <section className="py-16 lg:py-24 bg-background">
        <div className="max-w-[1400px] mx-auto px-6">
          <motion.div
          ...
          >
            ...
            <h2 className="font-display font-extrabold text-3xl lg:text-5xl text-[var(--ink)] tracking-tight mb-4">
              Why Scottish Businesses Choose Maundy Clean
            </h2>
            <p className="text-base lg:text-lg text-[var(--muted-foreground)] leading-relaxed">
              We&rsquo;re a local specialist, not an impersonal national agency. Our PVG-checked
              corporate crews live in your area, know your neighbourhood, and stay with you for the
        ...
        <div className="max-w-[1400px] mx-auto px-6">
          ...
          >
            ...
            <p className="text-base lg:text-lg text-[var(--muted-foreground)] leading-relaxed max-w-2xl mx-auto">
              ...
              survey, get matched with a local PVG-checked crew, and enjoy a pristine workplace
      ...
      {/* H2: Specialist Services for Every Commercial Cycle */}
      {/* ============================================================ */}
      <section className="py-16 lg:py-24 bg-background">
        <div className="max-w-[1400px] mx-auto px-6">
          <motion.div
          ...
          >
            <span className="text-xs font-bold uppercase tracking-[0.18em] text-[var(--brand)] mb-3 inline-block">
              Beyond the daily clean &middot; commercial cycles
            </span>
            <h2 className="font-display font-extrabold text-3xl lg:text-5xl text-[var(--ink)] tracking-tight mb-4">
              Specialist Services for Every Commercial Cycle
            </h2>
            <p className="text-base lg:text-lg text-[var(--muted-foreground)] leading-relaxed">
              Our corporate facility cleaning is the heartbeat of your property&rsquo;s maintenance,
            ...
            {[
              {
                ...
                description:
                  "Moving offices? Our End of Tenancy Cleaning is perfect for businesses looking to fulfil lease requirements and secure their full deposit back. We work to the letting agent&rsquo;s inventory, restore the suite to its original condition, and come back free of charge if anything is flagged on the inspection.",
              ...
              },
              {
                ...
                description:
                  "If you&rsquo;ve had building work or office improvements, our After Builders Clean is designed to remove heavy layers of construction dust. Fine dust left on a commercial floor acts like sandpaper under foot traffic &mdash; we vacuum, damp-wipe, and protect every surface before the dust causes permanent damage.",
              ...
              },
              {
                ...
                description:
                  "For bars and eateries, our Restaurant Deep Cleaning provides the high-standard hygiene required for health and safety compliance. From kitchen extraction canopy degreasing to fryer boil-outs and food-safe surface sanitisation, our hospitality team understands HACCP and EHO inspection standards.",
              ...
              },
              {
                ...
                description:
                  "Ask about our Antiviral Sanitisation and electrostatic fogging treatments to keep your environment germ-free. Our electrostatic disinfection service covers every surface with an EN 14476-certified virucide &mdash; ideal for flu season, post-illness, or quarterly compliance resets.",
          ...
          >
            ...
            >
              ...
              Explore the full corporate facility cleaning service
              <ArrowRight className="w-4 h-4" />
            </Link>
          </motion.div>
        </div>
      ...
      {/* ============================================================ */}
      {/* SECTION 7 - Final CTA */}
      {/* H2: Ready for a Corporate Cleaning Crew Near You? */}
      {/* ============================================================ */}
        ...
        <div className="relative max-w-[1100px] mx-auto px-6 text-center">
          ...
          >
            <span className="text-xs font-bold uppercase tracking-[0.18em] text-[var(--gold)] mb-3 inline-block">
              Ready to book your local corporate crew?
            </span>
            <h2 className="font-display font-extrabold text-3xl lg:text-5xl text-white tracking-tight mb-4">
              Ready for a Corporate Facility Cleaning Crew Near You?
            </h2>
            <p className="text-base lg:text-lg text-white/80 leading-relaxed max-w-2xl mx-auto mb-8">
              ...
              Small Corporate facility through to a fully bespoke multi-site retainer. Coverage
      ...
      <section className="py-16 lg:py-24 bg-background">
        <div className="max-w-4xl mx-auto px-6">
          ...
          >
            <span className="text-xs font-bold uppercase tracking-[0.18em] text-[var(--brand)] mb-3 inline-block">
              Corporate facility cleaning near me &middot; FAQ
            </span>
            <h2 className="font-display font-extrabold text-3xl lg:text-5xl text-[var(--ink)] tracking-tight mb-4">
              Frequently Asked Questions
            </h2>
            <p className="text-base lg:text-lg text-[var(--muted-foreground)] leading-relaxed max-w-2xl mx-auto">
              Straight answers to the questions our local corporate facility cleaning clients ask
