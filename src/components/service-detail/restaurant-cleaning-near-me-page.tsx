...
const HERO_BADGES = [
  ...
  { icon: Leaf, label: "Guest-Safe, Non-Toxic Supplies" },
...
const TRUST_PILLARS = [
  {
    ...
    title: "Local Restaurant Specialists, Not an Impersonal Agency",
    description:
      "Maundy Clean is a Scottish restaurant and bar cleaning company built on the Maundy tradition of service and care. We don&rsquo;t operate as an impersonal national franchise &mdash; we&rsquo;re a local specialist with vetted uniformed crews living and working in your area. Whether you&rsquo;re searching for daily FOH reset on Glasgow&rsquo;s Merchant City, after-hours BOH turnover on Edinburgh&rsquo;s New Town, kitchen-extraction TR19 deep cleans in Aberdeen&rsquo;s Union Street, or neighbourhood pub cleaning anywhere in between, we assign a vetted, PAYE-employed crew that stays with you for the long run. Same team, same standard, same locked-in rate for 12 months.",
  },
  {
    icon: Users,
    title: "The Same Trusted Crew Every Visit",
    description:
      "Unlike gig-economy cleaning apps, we only employ our own staff. The same vetted, uniformed, and PVG-checked crew that manages your first clean is the crew that returns for every scheduled session. Continuity matters when the stakes are kitchen grease load, EHO inspection readiness, and a 100% re-clean guarantee &mdash; we don&rsquo;t send rotating crews of strangers to your venue. When your regular crew lead is on annual leave, we send a trained backup who has been briefed on your kitchen layout, your extraction system, and your glass-wash protocols, and we tell you in advance.",
  },
  {
    icon: Shield,
    title: "PVG-Checked, Food-Safe & £5m Public Liability",
    description:
      "Every technician carries Disclosure Scotland PVG scheme membership, and we train them on food-safe catering cleaning: HACCP-aware, allergen-aware, colour-coded microfibre (red for raw-meat prep, blue for cooked-food prep, green for salad and fruit, yellow for bar and washroom). We use non-toxic, guest-safe products by default &mdash; no harsh chemical odours left in dining areas &mdash; with eco-labelled alternatives for kitchens, bars, and FOH. All HSE-compliant chemicals come with COSHH datasheets on file. We hold &pound;5m public liability cover (suitable for independent bars, leased pub tenancies, restaurant groups, and licensed premises), &pound;5m employer&rsquo;s liability cover, and can name your venue on our policy as additional insured &mdash; a common requirement for licensed premises and brewery-tied leases.",
  },
  {
    icon: Award,
    title: "Signed Daily Checklists & 100% Satisfaction Guarantee",
    description:
      "Every restaurant and bar client gets a dedicated account manager who knows your venue, your team, your access protocols, and your HACCP plan &mdash; direct mobile number, 24-hour response, quarterly on-site walk-throughs. After every visit you receive a signed daily checklist (cleaner signature, duty manager counter-signature), arrival and departure times, tasks completed, and any issues flagged &mdash; like a leaking tap, a blown bulb, or a canopy filter due for TR19 deep clean &mdash; before they become complaints. We offer a free re-clean within 24 to 48 hours if you are not 100% satisfied, and our visit-completion rate in 2025 was 99.6%. From &pound;16 per hour for a small independent bar through to a fully bespoke retainer for a multi-site restaurant group.",
  },
];
...
const NEAR_ME_FAQS = [
  {
    ...
    a: "We cover 72+ towns and cities across Scotland &mdash; from Glasgow and Edinburgh in the Central Belt to Inverness in the Highlands and everywhere in between. Use the location grid above to find your town. If you don&rsquo;t see your postcode listed, call us &mdash; we add new restaurant and bar coverage areas every month and may already have a vetted uniformed crew near you.",
  },
  {
    q: "How quickly can a local restaurant cleaning crew start?",
    a: "From site survey to first clean in 5-7 working days for most postcodes in the Central Belt. For more remote areas (Highlands, Islands, Borders), allow 7-10 working days for crew routing and travel planning. Same-week starts are occasionally possible in Glasgow, Edinburgh, Stirling, and Dundee &mdash; call us to check availability. Large multi-venue restaurant contracts typically schedule 3-4 weeks out to allow for full site survey, proposal, mobilisation, and crew onboarding across every site.",
  },
  {
    q: "Will the crew travel to my restaurant, or do I need to bring anything to you?",
    a: "All restaurant and bar cleaning is performed on-site at your premises &mdash; we never transport anything off-site. Our crews arrive in liveried vans with commercial-grade vacuums (Sebo BS36/BS46, Henry HVR200), microfibre flat-mop systems, colour-coded cloths (red for raw-meat prep, blue for cooked-food prep, green for salad and fruit, yellow for bar and washroom), HSE-compliant chemicals with COSHH datasheets, PPE, squeegees for windows and mirrors, and EN 1276 food-safe bactericidal chemistry for kitchen surfaces and prep zones. You provide consumables (bin liners, paper towel, toilet paper, hand soap, sanitiser tablets) or we can manage consumable restocking for an additional monthly fee.",
  },
  {
    q: "Do you have restaurant cleaning crews experienced with EHO inspections and TR19 extraction deep cleans?",
    a: "Yes. Our catering-experienced crews are trained specifically on food-safety protocols &mdash; HACCP-aware, allergen-aware, and trained to use the right chemistry on the right surface (no chlorine sanitiser on stainless steel prep tables where it pits the surface, no caustic degreaser on aluminium). We degrease canopy filters weekly, deep clean the full extraction system (canopy, plenum, ductwork) to TR19 standard every 3 to 6 months depending on volume, and provide insurance-compliant post-clean certification &mdash; critical for your fire-safety audit, your landlord&rsquo;s compliance file, and your next EHO inspection. We currently service 38 restaurants across Scotland, including two Michelin Bib Gourmand restaurants and three Rosette-awarded kitchens.",
  },
  {
    q: "Can you handle secure access, alarm systems, and out-of-hours cleaning at my venue?",
    a: "Absolutely. We&rsquo;re trained on all major alarm systems (Texecom, Honeywell, Pyronix, Risco) and follow strict key-handling protocols: keys stored in a coded safe between visits, alarm codes encrypted and only released to your assigned crew lead, never labelled with your address. We hold &pound;5m public liability cover and &pound;5m employer&rsquo;s liability cover &mdash; suitable for independent bars, leased pub tenancies, restaurant groups, and licensed premises. The most common windows are pre-open (7am-9am) for a front-line ready reset, post-close (10pm-1am) for a full deep turnover, or split shifts (light touch during service, deep clean after hours).",
  },
  {
    q: "What&rsquo;s the difference between daily open & close, weekly, and after-hours restaurant cleaning near me?",
    a: "Daily open and close cleaning (typically 60-180 minutes per visit, Monday-Sunday) is the right choice for high-footfall restaurants, bars, and pubs where customers are in constant contact with surfaces and the kitchen is in daily use &mdash; the cumulative grease load and food debris is too high for less frequent visits. Weekly cleaning suits smaller neighbourhood pubs, low-traffic independent bistros, or private-event venues with limited service days. After-hours cleaning means your crew works when your customers and staff aren&rsquo;t there &mdash; typically 10pm-1am or 7am-9am &mdash; giving them the empty space they need to do a proper job without vacuuming around diners. We can also split: light touch during the day (FOH refresh and washroom checks every couple of hours), deep clean after hours. Your account manager will advise on the best schedule for your specific footprint, density, and trading hours.",
  },
];
...
export function RestaurantCleaningNearMeHero() {
  return (
    <>
      {/* ============================================================ */}
      {/* SECTION 1 - Hero */}
      {/* H1: Restaurant Cleaning Near Me in Scotland */}
      {/* ============================================================ */}
      <section className="relative overflow-hidden">
        <div className="absolute inset-0">
          <img
            src={IMG.heroWide}
            alt="Maundy Clean uniformed restaurant cleaning crew resetting a Glasgow bar and pub before opening"
        ...
        <div className="relative max-w-[1400px] mx-auto px-6 py-20 lg:py-28">
          ...
          >
            ...
            >
              ...
              72+ Scottish towns &middot; vetted uniformed restaurant crews &middot; Same team every visit
            </motion.div>
            ...
            >
              Restaurant Cleaning Near Me in Scotland
            </motion.h1>
            ...
            >
              ...
              every visit &mdash; wherever your venue happens to be. From &pound;16 per hour for a
              small independent bar through to a fully bespoke retainer for a multi-site restaurant
              group.
            </motion.p>
      ...
      {/* H2: Local Restaurant Cleaning You Can Trust */}
      {/* ============================================================ */}
        ...
        <div className="max-w-[1100px] mx-auto px-6">
          ...
          >
            <span className="text-xs font-bold uppercase tracking-[0.18em] text-[var(--brand)] mb-3 inline-block">
              Local restaurant &amp; bar cleaning &middot; Scotland-wide
            </span>
            <h2 className="font-display font-extrabold text-3xl lg:text-5xl text-[var(--ink)] tracking-tight mb-5">
              Local Restaurant Cleaning You Can Trust
            </h2>
            <p className="text-base lg:text-lg text-[var(--ink)]/85 leading-[1.75]">
              ...
              franchise &mdash; we&rsquo;re a local specialist with vetted uniformed crews living and
              working in your area. Whether you&rsquo;re searching for daily FOH reset on
              Glasgow&rsquo;s Merchant City, after-hours BOH turnover on Edinburgh&rsquo;s New Town,
              kitchen-extraction TR19 deep cleans in Aberdeen&rsquo;s Union Street, or neighbourhood
              pub cleaning anywhere in between, we assign a vetted, PAYE-employed crew that stays
      ...
      {/* H2: Find Your Local Restaurant Cleaning Crew */}
      {/* ============================================================ */}
          ...
          <div className="grid lg:grid-cols-[1fr_1.6fr] gap-10 lg:gap-14 items-start">
            ...
            >
              ...
              <h2 className="font-display font-extrabold text-3xl lg:text-5xl text-[var(--ink)] tracking-tight mb-4">
                Find Your Local Restaurant Cleaning Crew
              </h2>
              <p className="text-base lg:text-lg text-[var(--muted-foreground)] leading-relaxed mb-6">
                Our network of vetted, PVG-checked restaurant and bar cleaning crews spans the entire
                country. From the city-centre bars of the Central Belt to the neighbourhood pubs of
                the Highlands, we have a local team ready to care for your venue. Browse by region
              ...
              <div className="relative rounded-3xl overflow-hidden shadow-brand aspect-[4/3] bg-[var(--brand-dark)]">
                <img
                  src={IMG.scotlandMap}
                  alt="Map of Scotland showing Maundy Clean restaurant and bar cleaning coverage areas"
      ...
      {/* ============================================================ */}
      {/* SECTION 4 - Why Maundy Clean for your local restaurant cleaning */}
      {/* H2: Why Scottish Bars & Restaurants Choose Maundy Clean */}
      {/* ============================================================ */}
      <section className="py-16 lg:py-24 bg-background">
        <div className="max-w-[1400px] mx-auto px-6">
          <motion.div
          ...
          >
            ...
            <h2 className="font-display font-extrabold text-3xl lg:text-5xl text-[var(--ink)] tracking-tight mb-4">
              Why Scottish Bars &amp; Restaurants Choose Maundy Clean
            </h2>
            <p className="text-base lg:text-lg text-[var(--muted-foreground)] leading-relaxed">
              We&rsquo;re a local specialist, not an impersonal national franchise. Our vetted
              uniformed restaurant crews live in your area, know your city-centre bar scene, and stay
              with you for the long run. Here&rsquo;s what sets us apart from the gig-economy apps and
        ...
        <div className="max-w-[1400px] mx-auto px-6">
          ...
          >
            ...
            <p className="text-base lg:text-lg text-[var(--muted-foreground)] leading-relaxed max-w-2xl mx-auto">
              ...
              addressing the fast-paced needs of the independent bar scene. Book a free site survey,
              get matched with a local vetted uniformed crew, and enjoy a pristine venue &mdash; no
      ...
      {/* H2: Specialist Services for Every Restaurant Cycle */}
      {/* ============================================================ */}
      <section className="py-16 lg:py-24 bg-background">
        <div className="max-w-[1400px] mx-auto px-6">
          <motion.div
          ...
          >
            <span className="text-xs font-bold uppercase tracking-[0.18em] text-[var(--brand)] mb-3 inline-block">
              Beyond the daily clean &middot; restaurant cycles
            </span>
            <h2 className="font-display font-extrabold text-3xl lg:text-5xl text-[var(--ink)] tracking-tight mb-4">
              Specialist Services for Every Restaurant Cycle
            </h2>
            <p className="text-base lg:text-lg text-[var(--muted-foreground)] leading-relaxed">
              Our restaurant cleaning is the heartbeat of your venue&rsquo;s hygiene, but we provide
              ...
              fabric care that rejuvenates your seating. The same trusted crew can step up whenever
              your venue needs more than a standard visit.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              },
              {
                ...
                description:
                  "Opening a new site or moving venues? Our End of Tenancy Cleaning ensures properties are front-line ready for your launch. We work to the letting agent&rsquo;s inventory and come back free of charge if anything is flagged on the inspection.",
              ...
              },
              {
                ...
                description:
                  "If your venue has had home improvements or shopfitting, our After Builders Clean is designed to remove heavy layers of builders&rsquo; dust and grime before reopening day. Fine dust acts like sandpaper under foot traffic &mdash; we vacuum, damp-wipe, and protect every surface.",
              ...
              },
              {
                ...
                description:
                  "Rejuvenate your seating with our Upholstery Cleaning service to remove unwanted odours and stains. Booth banquettes, bar stools, and soft furnishings absorb food, drink, and grease odours &mdash; our hot-water extraction lifts the soil and the smell.",
          ...
          >
            ...
            >
              ...
              Explore the full restaurant cleaning service
              <ArrowRight className="w-4 h-4" />
            </Link>
          </motion.div>
        </div>
      ...
      {/* ============================================================ */}
      {/* SECTION 7 - Final CTA */}
      {/* H2: Ready for a Restaurant Cleaning Crew Near You? */}
      {/* ============================================================ */}
        ...
        <div className="relative max-w-[1100px] mx-auto px-6 text-center">
          ...
          >
            ...
            <p className="text-base lg:text-lg text-white/80 leading-relaxed max-w-2xl mx-auto mb-8">
              ...
              bespoke multi-site restaurant retainer. Coverage across 72+ Scottish towns.
            </p>
      ...
      <section className="py-16 lg:py-24 bg-background">
        <div className="max-w-4xl mx-auto px-6">
          ...
          >
            <span className="text-xs font-bold uppercase tracking-[0.18em] text-[var(--brand)] mb-3 inline-block">
              Restaurant cleaning near me &middot; FAQ
            </span>
            <h2 className="font-display font-extrabold text-3xl lg:text-5xl text-[var(--ink)] tracking-tight mb-4">
              Frequently Asked Questions
            </h2>
            <p className="text-base lg:text-lg text-[var(--muted-foreground)] leading-relaxed max-w-2xl mx-auto">
              Straight answers to the questions our local restaurant and bar cleaning clients ask
