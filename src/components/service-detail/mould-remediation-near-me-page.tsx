...
const IMG = {
  hero: "https://maundyclean.sirv.com/Images/WhatsApp%20Image%202026-07-22%20at%208.30.33%20PM.jpeg",
...
// Hero Section
// ============================================================
export function MouldRemediationNearMeHero() {
  return (
    <section className="relative min-h-[460px] flex items-center justify-center bg-[var(--brand-dark)] text-white overflow-hidden py-16">
      <div className="absolute inset-0 z-0">
        ...
        <img
          src={IMG.hero}
          alt="Mould Remediation Scotland Near Me"
      ...
      <div className="relative z-10 max-w-[1000px] mx-auto px-6 text-center space-y-6">
        ...
        <h1 className="font-display text-4xl sm:text-5xl font-extrabold tracking-tight leading-[1.15]">
          Mould Remediation & Mould Cleaning Services Near Me
        </h1>
        <p className="text-base sm:text-lg text-white/90 max-w-2xl mx-auto leading-relaxed">
          Localised environmental restoration specialists serving Glasgow, Edinburgh, Aberdeen, Dundee, and all surrounding Scottish municipalities.
        </p>
...
// ============================================================
export function MouldRemediationNearMeGrid() {
      ...
      <div className="max-w-[1200px] mx-auto px-6 space-y-12">
        <div className="text-center max-w-3xl mx-auto space-y-4">
          ...
          <h2 className="font-display text-3xl sm:text-4xl font-extrabold tracking-tight">
            Our Certified Local Mould Remediation Coverage Areas
          </h2>
                    ...
                    >
                      <div className="space-y-4">
                        ...
                        <p className="text-xs text-[var(--muted-foreground)] leading-relaxed">
                          Professional black mould cleaning, spore containment, air scrubbing, and comprehensive dampness restoration services for residential and commercial spaces in {city.city}.
                        </p>
                      ...
                      <div className="pt-6">
                        ...
                        >
                          <Link href={`/quote?location=${city.slug}`}>
                            Book {city.city} Remediation Team
                          </Link>
                        </Button>
                      </div>
                    </div>
...
// ============================================================
export function MouldRemediationNearMeDispatch() {
  return (
      ...
      <div className="max-w-[1200px] mx-auto px-6 grid lg:grid-cols-[1.2fr_0.8fr] gap-12 items-center">
        <div className="space-y-6">
          ...
          <div className="space-y-4 text-sm sm:text-base leading-relaxed text-[var(--muted-foreground)]">
            ...
            <p>
              We don&apos;t just wipe away the visible mould; we identify the underlying moisture sources (such as cold spots, leaks, or condensation issues) and use specialized HEPA-filtered air scrubbers to trap airborne spores, preventing cross-contamination to unaffected rooms.
            </p>
          </div>
...
// ============================================================
export function MouldRemediationNearMeCta() {
  return (
    <section className="py-16 bg-[var(--brand-dark)] text-white relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-[900px] mx-auto px-6 text-center space-y-6">
        <h3 className="font-display text-3xl sm:text-4xl font-extrabold tracking-tight leading-tight">
          Ready to Connect with Your Local Mould Remediation Specialists?
        </h3>
        <p className="text-sm sm:text-base text-white/90 max-w-2xl mx-auto leading-relaxed">
          Don&apos;t let mould affect the air quality and structure of your property. Our localized teams are on standby across Scotland to restore biological safety, cleanliness, and peace of mind.
        </p>
        <div className="flex flex-wrap justify-center gap-4 pt-4">
          <Button
            size="lg"
          ...
          <Button
            ...
            asChild
          >
            <Link href="/services/mould-remediation-cleaning">View Service Details</Link>
          </Button>
        </div>
...
const FAQ_ITEMS: FaqItem[] = [
  {
    q: "How quickly can your local mould remediation team arrive?",
  ...
  },
  {
    ...
    a: "Yes. All our technicians are fully vetted, background-checked, and highly trained in HSE mould guidelines and COSHH compliance. We carry £5M public liability insurance as standard.",
  },
  {
...
export function MouldRemediationNearMeFaq() {
      ...
      <div className="max-w-[800px] mx-auto px-6 space-y-12">
        <div className="text-center space-y-4">
          ...
          <h2 className="font-display text-3xl font-extrabold tracking-tight leading-tight">
            Common Local Mould Remediation Questions
          </h2>
        </div>
