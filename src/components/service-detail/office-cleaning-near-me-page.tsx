...
const IMG = {
  heroWide:
    "https://maundyclean.sirv.com/Images/WhatsApp%20Image%202026-07-21%20at%209.24.32%20PM.jpeg",
  scotlandMap:
...
const HERO_BADGES = [
  ...
  { icon: Clock, label: "After-Hours & Early-Morning" },
];
...
const TRUST_PILLARS = [
  {
    icon: Building2,
    title: "Local Commercial Specialists, Not an Impersonal Agency",
    description:
      "Maundy Clean is a Scottish commercial cleaning company built on the Maundy tradition of service and care. We don&rsquo;t operate as an impersonal national agency &mdash; we&rsquo;re a local specialist with PVG-checked crews living and working in your area. Whether you&rsquo;re searching for daily office cleaning in Glasgow&rsquo;s financial district, after-hours janitorial service in Edinburgh&rsquo;s New Town, or GDPR-aware cleaning for a legal firm in Aberdeen, we assign a vetted, PAYE-employed crew that stays with you for the long run. Same team, same standard, same locked-in rate for 12 months.",
  },
  {
    icon: Users,
  ...
  {
    icon: Shield,
    title: "PVG-Checked, GDPR-Aware & HSE-Compliant",
    description:
      "Every technician carries Disclosure Scotland PVG scheme membership, and we train them on GDPR-aware commercial cleaning: don&rsquo;t touch documents on desks, don&rsquo;t plug or unplug devices, don&rsquo;t photograph the space, don&rsquo;t discuss what you&rsquo;ve seen. All HSE-compliant chemicals come with COSHH datasheets on file, and we default to eco-labelled products with hospital-grade alternatives for medical or food-prep areas. We hold &pound;5m public liability cover, &pound;5m employer&rsquo;s liability cover, and can provide enhanced background checks and additional NDAs for sensitive environments.",
  },
  {
    icon: Award,
    title: "Dedicated Account Manager & 100% Satisfaction Guarantee",
    description:
      "Every office client gets a dedicated account manager who knows your building, your team, your access protocols, and your priorities &mdash; direct mobile number, 24-hour response, quarterly on-site walk-throughs. We offer a free re-clean within 24 to 48 hours if you are not 100% satisfied, and our visit-completion rate in 2025 was 99.6%. From &pound;89 per visit for a Small Office through to a fully bespoke contract for a multi-floor headquarters, the Maundy Clean standard applies on every visit.",
  },
];
...
export function OfficeCleaningNearMeHero() {
  return (
    <>
      {/* ============================================================ */}
      {/* SECTION 1 - Hero */}
      {/* H1: Office Cleaning Services Near Me in Scotland */}
      {/* ============================================================ */}
      <section className="relative overflow-hidden">
        <div className="absolute inset-0">
          <img
            src={IMG.heroWide}
            alt="Maundy Clean uniformed commercial cleaning crew resetting an open-plan office in Scotland after hours"
        ...
        <div className="relative max-w-[1400px] mx-auto px-6 py-20 lg:py-28">
          ...
          >
            ...
            >
              ...
              72+ Scottish towns &middot; PVG-checked commercial crews &middot; Same team every visit
            </motion.div>
            ...
            >
              ...
              happens to be. From &pound;89 per visit for a Small Office through to a fully bespoke
              contract for a multi-floor headquarters.
            </motion.p>
      ...
      {/* H2: Local Commercial Office Cleaning You Can Trust */}
      {/* ============================================================ */}
        ...
        <div className="max-w-[1100px] mx-auto px-6">
          ...
          >
            <span className="text-xs font-bold uppercase tracking-[0.18em] text-[var(--brand)] mb-3 inline-block">
              Local commercial office cleaning &middot; Scotland-wide
            </span>
            <h2 className="font-display font-extrabold text-3xl lg:text-5xl text-[var(--ink)] tracking-tight mb-5">
              Local Commercial Office Cleaning You Can Trust
            </h2>
            <p className="text-base lg:text-lg text-[var(--ink)]/85 leading-[1.75]">
              Maundy Clean is a Scottish commercial cleaning company built on the Maundy tradition of
              service and care. We don&rsquo;t operate as an impersonal national agency &mdash;
              we&rsquo;re a local specialist with PVG-checked crews living and working in your area.
              Whether you&rsquo;re searching for daily office cleaning in Glasgow&rsquo;s financial
              district, after-hours janitorial service in Edinburgh&rsquo;s New Town, GDPR-aware
              cleaning for a legal firm in Aberdeen, or restaurant kitchen deep cleaning anywhere in
              between, we assign a vetted, PAYE-employed crew that stays with you for the long run.
      ...
      {/* H2: Find Your Local Office Cleaning Crew */}
      {/* ============================================================ */}
          ...
          <div className="grid lg:grid-cols-[1fr_1.6fr] gap-10 lg:gap-14 items-start">
            ...
            >
              ...
              <h2 className="font-display font-extrabold text-3xl lg:text-5xl text-[var(--ink)] tracking-tight mb-4">
                Find Your Local Office Cleaning Crew
              </h2>
              <p className="text-base lg:text-lg text-[var(--muted-foreground)] leading-relaxed mb-6">
                Our network of vetted, PVG-checked commercial cleaning crews spans the entire
              ...
              <div className="relative rounded-3xl overflow-hidden shadow-brand aspect-[4/3] bg-[var(--brand-dark)]">
                <img
                  src={IMG.scotlandMap}
                  alt="Map of Scotland showing Maundy Clean office cleaning coverage areas"
                      ...
                      {regionGroup.cities.map((loc) => (
                        ...
                        >
                          ...
                          <span>
                            ...
                            <span className="text-[var(--muted-foreground)]"> office</span>
                          </span>
                        </Link>
                      ))}
                    </div>
      ...
      {/* ============================================================ */}
      {/* SECTION 4 - Why Maundy Clean for your local office cleaning */}
        ...
        <div className="max-w-[1400px] mx-auto px-6">
          ...
          >
            ...
            <p className="text-base lg:text-lg text-[var(--muted-foreground)] leading-relaxed">
              ...
              commercial crews live in your area, know your neighbourhood, and stay with you for the
      ...
      <section className="py-16 lg:py-24 bg-background">
        <div className="max-w-[1400px] mx-auto px-6">
          ...
          >
            ...
            <p className="text-base lg:text-lg text-[var(--muted-foreground)] leading-relaxed">
              Our office cleaning is the heartbeat of your property&rsquo;s maintenance, but we
              provide specialized support for major transitions &mdash; from industry-specific
            ...
            {[
              {
                ...
                description:
                  "We provide specialist Restaurant Deep Cleaning to help hospitality businesses meet rigorous health and safety standards. From kitchen extraction canopy degreasing to fryer boil-outs and food-safe surface sanitisation, our hospitality team understands HACCP, EHO inspection standards, and the deadlines of operating a commercial kitchen.",
              ...
              },
              {
                ...
                description:
                  "Book an Antiviral Sanitisation or &ldquo;Covid-19 Deep Cleaning &amp; Fogging&rdquo; session to keep your environment germ-free. Our electrostatic disinfection service covers every surface with an EN 14476-certified virucide &mdash; ideal for flu season, post-illness, or quarterly compliance resets.",
          ...
          >
            ...
            >
              ...
              Explore the full office cleaning service
              <ArrowRight className="w-4 h-4" />
            </Link>
          </motion.div>
        </div>
      ...
      {/* ============================================================ */}
      {/* SECTION 7 - Final CTA */}
      {/* H2: Ready for an Office Cleaning Crew Near You? */}
      {/* ============================================================ */}
        ...
        <div className="relative max-w-[1100px] mx-auto px-6 text-center">
          ...
          >
            <span className="text-xs font-bold uppercase tracking-[0.18em] text-[var(--gold)] mb-3 inline-block">
              Ready to book your local office crew?
            </span>
            <h2 className="font-display font-extrabold text-3xl lg:text-5xl text-white tracking-tight mb-4">
              Ready for an Office Cleaning Crew Near You?
            </h2>
            <p className="text-base lg:text-lg text-white/80 leading-relaxed max-w-2xl mx-auto mb-8">
              Book a free site survey with our management team and receive an itemised proposal
              within 2 business days. PVG-checked crews, GDPR-aware workstation care, HSE-compliant
              supplies, monthly cleaning logs, and a 100% satisfaction guarantee &mdash; from
              &pound;89 per visit for a Small Office through to a fully bespoke contract for a
              multi-floor headquarters. Coverage across 72+ Scottish towns.
            </p>
      ...
      <section className="py-16 lg:py-24 bg-background">
        <div className="max-w-4xl mx-auto px-6">
          ...
          >
            <span className="text-xs font-bold uppercase tracking-[0.18em] text-[var(--brand)] mb-3 inline-block">
              Office cleaning near me &middot; FAQ
            </span>
            <h2 className="font-display font-extrabold text-3xl lg:text-5xl text-[var(--ink)] tracking-tight mb-4">
              Frequently Asked Questions
            </h2>
            <p className="text-base lg:text-lg text-[var(--muted-foreground)] leading-relaxed max-w-2xl mx-auto">
              Straight answers to the questions our local office cleaning clients ask most often.
