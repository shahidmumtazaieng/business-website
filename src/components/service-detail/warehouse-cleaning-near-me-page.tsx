...
const HERO_BADGES = [
  ...
  { icon: ShieldCheck, label: "CSCS-Carded & IPAF Operators" },
  { icon: Clock, label: "Shift Patterns Around 24/7 Sites" },
];
...
const TRUST_PILLARS = [
  {
    icon: Warehouse,
    title: "Local Industrial Specialists, Not an Impersonal Agency",
    description:
      "Maundy Clean is a Scottish industrial cleaning company built on the Maundy tradition of service and care. We don&rsquo;t operate as an impersonal national franchise &mdash; we&rsquo;re a local specialist with vetted, uniformed, CSCS-carded crews living and working in your area. Whether you&rsquo;re searching for nightly distribution-centre cleaning on Glasgow&rsquo;s orbital logistics hubs (Eurocentral, Bellshill, Uddingston), weekend factory degreasing on Edinburgh&rsquo;s Midlothian logistics corridor (Sheriffhall, Straiton), cold-storage sanitation on Aberdeen&rsquo;s Altens and Tullos industrial estates, or neighbourhood 3PL cleaning on Dundee&rsquo;s dockside and tech parks anywhere in between, we assign a vetted, PAYE-employed crew that stays with you for the long run. Same team, same standard, same locked-in rate for 12 months.",
  },
  {
    icon: Users,
    title: "The Same Trusted Crew Every Visit",
    description:
      "Unlike gig-economy cleaning apps, we only employ our own staff. The same vetted, uniformed, CSCS-carded, IPAF-certified crew that manages your first clean is the crew that returns for every scheduled session. Continuity matters when the stakes are 18,000 sqm distribution floors, 8&ndash;12m high-bay racking, combustible-dust HSE compliance, BRCGS audit-readiness, and forklift-aware MHE safety protocols &mdash; we don&rsquo;t send rotating crews of agency strangers walking an active picking aisle. When your regular crew lead is on annual leave, we send a trained backup who has been briefed on your facility layout, your MHE traffic routes, your racking layout, your permit-to-work protocols, and your access preferences &mdash; and we tell you in advance.",
  },
  {
    icon: ShieldCheck,
    title: "CSCS-Carded, IPAF-Certified & £10m Public Liability",
    description:
      "Every technician carries a CSCS card where required, is IPAF-certified (3a, 3b, 1b) for powered access, PASMA-certified for mobile towers, and is trained on industrial-specific protocols before stepping foot on site: HSE and COSHH compliance, combustible-dust management (HEPA-filtered industrial vacuums &mdash; never compressed air, which redistributes dust and creates explosion risk in some dust classes), high-reach dusting on racking and rafters, factory floor degreasing, chiller room and cold storage sanitisation (thermal PPE, low-temp chemistry, heated scrubber-dryers, working at &minus;25&deg;C), and audit-ready documentation for BRCGS, MHRA, ISO 9001, and major customer audits. We use non-toxic, child-safe, food-safe chemistry by default in canteen, office, and welfare zones, with eco-labelled alternatives for sensitive areas. All HSE-compliant chemicals come with COSHH datasheets on file. We hold &pound;10m public liability as standard &mdash; higher than typical, suitable for major logistics contracts &mdash; full employer&rsquo;s liability, professional indemnity, and can name your business on our policy as additional insured.",
  },
  {
    icon: Award,
    title: "Signed Cleaning Logs & 100% Satisfaction Guarantee",
    description:
      "Every industrial client gets a dedicated account manager who knows your facility, your operations team, your shift patterns, and your audit regime &mdash; direct mobile number, 24-hour response, monthly compliance walk-throughs alongside your operations manager. After every visit you receive a signed cleaning log (operative signature, shift-supervisor counter-signature on request), arrival and departure times, tasks completed, and any issues flagged &mdash; like a hydraulic spill on the dispatch floor, a damaged pallet in a picking aisle, a blocked fire exit, or a low-stock consumable in the welfare block &mdash; before they undermine a shift handover, an audit walk-through, or an HSE inspection. We offer a free re-clean within 24 to 48 hours if you are not 100% satisfied, and our visit-completion rate in 2025 was 99.6%. From &pound;14 per hour for a small single-shift warehouse through to a fully bespoke retainer for a multi-site national distribution network.",
  },
];
...
const BOOKING_STEPS = [
  {
    ...
    description:
      "Contact us for a free, no-obligation site survey with our management team. We walk your facility with your operations manager and your H&amp;S team, identify your product type (ambient, chilled, frozen, food, pharma, electronics, general), your MHE traffic routes, your racking layout, your access windows (night shift, weekend, or specific quiet windows during shift handover), and your audit/compliance regime (BRCGS, MHRA, ISO 9001, customer audit). We develop a bespoke schedule and standards of excellence tailored to your facility&rsquo;s unique operational needs. We send an itemised proposal within 2 business days: crew size, visit frequency, time on-site, scope of work, fixed monthly rate, RAMS, COSHH datasheets, and a draft cleaning schedule. No pushy sales call, no waiting 24 hours for a callback. The price you see is the price you pay &mdash; locked in for 12 months.",
  },
  {
    icon: UserCheck,
    step: "02",
  ...
  },
  {
    ...
    description:
      "Experience a workspace that looks, smells, and feels fresh every single day, backed by our 100% satisfaction guarantee. You receive a signed cleaning log after every visit, arrival and departure times, tasks completed, and any issues flagged. Your dedicated account manager visits monthly for a compliance walk-through with your operations manager, and proactively raises concerns before they undermine a shift handover, an audit walk-through, or an HSE inspection. From &pound;14 per hour for a small single-shift warehouse through to a fully bespoke multi-site national distribution retainer. We hold &pound;10m public liability as standard and can name your business on our policy as additional insured.",
  },
];
...
export function WarehouseCleaningNearMeHero() {
  return (
    <>
      {/* ============================================================ */}
      {/* SECTION 1 - Hero */}
      {/* H1: Warehouse Cleaning Near Me in Scotland */}
      {/* ============================================================ */}
      <section className="relative overflow-hidden">
        <div className="absolute inset-0">
          <img
            src={IMG.heroWide}
            alt="Maundy Clean CSCS-carded, IPAF-certified industrial cleaning crew resetting a Scottish distribution centre before shift"
        ...
        <div className="relative max-w-[1400px] mx-auto px-6 py-20 lg:py-28">
          ...
          >
            ...
            >
              ...
              72+ Scottish towns &middot; CSCS &amp; IPAF crews &middot; Same team every visit
            </motion.div>
            ...
            >
              ...
              same dedicated crew every visit &mdash; wherever your facility happens to be. From
              &pound;14 per hour for a small single-shift warehouse through to a fully bespoke
              retainer for a multi-site national distribution network.
            </motion.p>
      ...
      {/* H2: Local Industrial Cleaning You Can Trust */}
      {/* ============================================================ */}
        ...
        <div className="max-w-[1100px] mx-auto px-6">
          ...
          >
            <span className="text-xs font-bold uppercase tracking-[0.18em] text-[var(--brand)] mb-3 inline-block">
              Local industrial cleaning &middot; Scotland-wide
            </span>
            <h2 className="font-display font-extrabold text-3xl lg:text-5xl text-[var(--ink)] tracking-tight mb-5">
              Local Industrial Cleaning You Can Trust
            </h2>
            <p className="text-base lg:text-lg text-[var(--ink)]/85 leading-[1.75]">
              Maundy Clean is a Scottish industrial cleaning company built on the Maundy tradition
              of service and care. We don&rsquo;t operate as an impersonal national franchise
              &mdash; we&rsquo;re a local specialist with vetted, uniformed, CSCS-carded crews
              living and working in your area. Whether you&rsquo;re searching for nightly
              distribution-centre cleaning on Glasgow&rsquo;s orbital logistics hubs (Eurocentral,
              Bellshill, Uddingston), weekend factory degreasing on Edinburgh&rsquo;s Midlothian
              logistics corridor (Sheriffhall, Straiton), cold-storage sanitation on Aberdeen&rsquo;s
              Altens and Tullos industrial estates, or neighbourhood 3PL cleaning on Dundee&rsquo;s
              dockside and tech parks anywhere in between, we assign a vetted, PAYE-employed crew
      ...
      {/* H2: Find Your Local Industrial Cleaning Crew */}
      {/* ============================================================ */}
          ...
          <div className="grid lg:grid-cols-[1fr_1.6fr] gap-10 lg:gap-14 items-start">
            ...
            >
              ...
              <h2 className="font-display font-extrabold text-3xl lg:text-5xl text-[var(--ink)] tracking-tight mb-4">
                Find Your Local Industrial Cleaning Crew
              </h2>
              <p className="text-base lg:text-lg text-[var(--muted-foreground)] leading-relaxed mb-6">
                Our network of vetted, CSCS-carded, IPAF-certified industrial cleaning crews spans
                the entire country. From the distribution centres and 3PL operations of the Central
                Belt to the cold storage and factories of the Highlands, we have a local team ready
                to care for your facility. Browse by region below, or call us to confirm coverage
              ...
              <div className="relative rounded-3xl overflow-hidden shadow-brand aspect-[4/3] bg-[var(--brand-dark)]">
                <img
                  src={IMG.scotlandMap}
                  alt="Map of Scotland showing Maundy Clean warehouse and industrial cleaning coverage areas"
                ...
                <div className="absolute bottom-4 left-4 right-4 bg-white/95 backdrop-blur rounded-xl p-4">
                  ...
                  <p className="text-xs text-[var(--muted-foreground)] leading-relaxed">
                    Same CSCS-carded, IPAF-certified crews, same 100% satisfaction guarantee
      ...
      {/* ============================================================ */}
      {/* SECTION 4 - Why Maundy Clean for your local industrial cleaning */}
      {/* H2: Why Scottish Industry Chooses Maundy Clean */}
      {/* ============================================================ */}
      <section className="py-16 lg:py-24 bg-background">
        <div className="max-w-[1400px] mx-auto px-6">
          <motion.div
          ...
          >
            ...
            <h2 className="font-display font-extrabold text-3xl lg:text-5xl text-[var(--ink)] tracking-tight mb-4">
              Why Scottish Industry Chooses Maundy Clean
            </h2>
            <p className="text-base lg:text-lg text-[var(--muted-foreground)] leading-relaxed">
              We&rsquo;re a local specialist, not an impersonal national franchise. Our vetted,
              uniformed, CSCS-carded, IPAF-certified industrial crews live in your area, know your
              city&rsquo;s logistics scene, and stay with you for the long run. Here&rsquo;s what
              sets us apart from the gig-economy apps and high-turnover agencies operating in
              Scotland.
            </p>
          </motion.div>
        ...
        <div className="max-w-[1400px] mx-auto px-6">
          ...
          >
            ...
            <p className="text-base lg:text-lg text-[var(--muted-foreground)] leading-relaxed max-w-2xl mx-auto">
              ...
              survey, get matched with a local vetted CSCS-carded, IPAF-certified crew, and enjoy a
      ...
      {/* H2: Specialist Services for Every Industrial Milestone */}
      {/* ============================================================ */}
      <section className="py-16 lg:py-24 bg-background">
        <div className="max-w-[1400px] mx-auto px-6">
          <motion.div
          ...
          >
            ...
            <h2 className="font-display font-extrabold text-3xl lg:text-5xl text-[var(--ink)] tracking-tight mb-4">
              Specialist Services for Every Industrial Milestone
            </h2>
            <p className="text-base lg:text-lg text-[var(--muted-foreground)] leading-relaxed">
              Our daily warehouse cleaning is the heartbeat of your facility&rsquo;s operational
              safety, but we provide specialized support for major milestones &mdash; from new unit
              launches and post-refurbishment dust clear-outs to antiviral hygiene resets and
              specialist fabric and window restoration. The same trusted, vetted crew can step up
            ...
            {[
              {
                ...
                description:
                  "Occupying a new unit? Our End of Tenancy Cleaning ensures properties are front-line ready for launch and pass all initial safety inspections. We work to the letting agent&rsquo;s inventory and come back free of charge if anything is flagged on the inspection.",
              ...
              },
              {
                ...
                description:
                  "If your factory has had home improvements or new machinery installed, our After Builders Clean is designed to remove heavy layers of builders&rsquo; dust and grime before reopening day. Fine dust acts like sandpaper under forklift traffic &mdash; we vacuum, damp-wipe, and protect every surface.",
              ...
              },
              {
                ...
                description:
                  "Ask about our specialist Antiviral Sanitisation and deep-disinfection services for high-touch industrial surfaces. EN 14476 virucidal chemistry is fogged and wiped across every high-touch surface &mdash; reducing seasonal colds, flu, and norovirus among your shift.",
              ...
              },
              {
                ...
                description:
                  "Rejuvenate communal seating in your canteen, supervisor office, or reception area with our Upholstery Cleaning, or brighten your facility with our high-reach Window Cleaning services. The detail that turns a &ldquo;cleaned&rdquo; warehouse into a &ldquo;speechlessly spotless&rdquo; one.",
          ...
          >
            ...
            >
              ...
              Explore the full warehouse &amp; industrial cleaning service
              <ArrowRight className="w-4 h-4" />
            </Link>
          </motion.div>
        </div>
      ...
      {/* ============================================================ */}
      {/* SECTION 7 - Final CTA */}
      {/* H2: Ready for an Industrial Cleaning Crew Near You? */}
      {/* ============================================================ */}
        ...
        <div className="relative max-w-[1100px] mx-auto px-6 text-center">
          ...
          >
            <span className="text-xs font-bold uppercase tracking-[0.18em] text-[var(--gold)] mb-3 inline-block">
              Ready to book your local industrial crew?
            </span>
            <h2 className="font-display font-extrabold text-3xl lg:text-5xl text-white tracking-tight mb-4">
              Ready for an Industrial Cleaning Crew Near You?
            </h2>
            <p className="text-base lg:text-lg text-white/80 leading-relaxed max-w-2xl mx-auto mb-8">
              Book a free, no-obligation site survey with our management team and receive an
              itemised proposal within 2 business days. Vetted CSCS-carded professionals, the same
              dedicated team every visit, HSE and COSHH compliance, IPAF-trained operators for
              high-reach work, child-safe eco chemistry, signed cleaning logs, &pound;10m public
              liability as standard, and a 100% satisfaction guarantee &mdash; from &pound;14 per
              hour for a small single-shift warehouse through to a fully bespoke multi-site national
              distribution retainer. Coverage across 72+ Scottish towns.
            </p>
      ...
      <section className="py-16 lg:py-24 bg-background">
        <div className="max-w-4xl mx-auto px-6">
          ...
          >
            <span className="text-xs font-bold uppercase tracking-[0.18em] text-[var(--brand)] mb-3 inline-block">
              Warehouse cleaning near me &middot; FAQ
            </span>
            <h2 className="font-display font-extrabold text-3xl lg:text-5xl text-[var(--ink)] tracking-tight mb-4">
              Frequently Asked Questions
            </h2>
            <p className="text-base lg:text-lg text-[var(--muted-foreground)] leading-relaxed max-w-2xl mx-auto">
              Straight answers to the questions our local industrial cleaning clients ask most
