...
const TRUST_PILLARS = [
  {
    icon: Users,
    title: "The Same Trusted Escalator Care Crew Every Time",
    description:
      "Unlike gig-economy cleaning apps, we only employ our own staff. The same vetted, uniformed, and background-checked escalator & lift specialists who manage your regular escalator & lift cleaning are the ones performing your Rosemor Rotomatic step-tread deep cleaning, EN 14476 virucidal handrail sanitisation, and HEPA dry mechanism vacuuming high-reach programmes. Continuity matters when the stakes are a Glasgow IFSD corporate escalator bank, an Edinburgh retail-chain escalator bank, or an Aberdeen hotel-lobby glass lift shaft &mdash; we don&rsquo;t send rotating crews of strangers to your property.",
  },
  {
    icon: Droplets,
    title: "Pure-Water De-Ionised Systems & Reach-and-Wash Poles",
    description:
      "Our escalator & lift specialists understand every variety of commercial escalator and lift equipment &mdash; from step-tread rubber, comb-plate aluminium, and balustrade glass through handrail rubber, lift-car stainless steel, mirror, and control panel. We identify the equipment type, the surface material, and the access constraints before we touch the surface, then apply the right protocol: Rosemor Rotomatic rotary-brush escalator deep-cleaner, EN 14476 virucidal handrail applicator, lint-free microfibre edge detailing, EN 14476 virucidal handrail sanitisation up to 65 feet for high-reach internal and external vertical transport, and HEPA dry mechanism vacuuming or Mobile Platform operation for surfaces exceeding 65 feet. Wrong chemistry on escalator rubber equals permanent damage &mdash; we refuse to clean what we cannot safely treat.",
  },
  {
    icon: Mountain,
    title: "HEPA dry mechanism vacuuming, LOLER-compliant lift-engineer support & Cradle Systems",
    description:
      "For surfaces exceeding standard heights, we provide specialist teams trained in HEPA dry mechanism vacuuming (IRATA-certified), LOLER-compliant lift-engineer support (IPAF-certified cherry-picker and scissor-lift), and BMU (Building Maintenance Unit) cradle operation for buildings with permanent cradle systems. Carbon-fibre telescopic poles for high-reach internal atrium vertical transport up to 65 feet from ground level &mdash; no ladders, no MEWP, no scaffolding. All cleaning solutions are certified non-toxic, biodegradable, child-safe, and surface-safe &mdash; EN 14476 virucidal chemistry is REACH-compliant. The equipment is safe for staff and visitors to walk past mid-clean.",
  },
  {
    icon: Award,
    title: "Fully Insured & 100% Satisfaction Guaranteed",
    description:
      "Every escalator & lift specialist is Disclosure Scotland PVG-checked, we hold &pound;5m public liability cover, and we offer a free re-clean within 24 to 48 hours if you are not 100% satisfied. We are a registered Scottish company &mdash; not a gig-economy agency &mdash; and the Maundy Clean standard applies on every visit. From &pound;180 per visit for a single escalator or lift car through to &pound;POA for multi-site shopping-centre and transport-hub contracts with 24/7 coverage, with a written defect report on every visit and 12-month rate-lock on every contract.",
  },
];
...
const BOOKING_STEPS = [
  {
    ...
    description:
      "Tell us about your escalator banks, lift cars, and access constraints &mdash; and receive a fixed-price equipment-care quote in under a minute. Our team will advise on the best Rosemor Rotomatic, EN 14476 virucidal sanitisation, or HEPA dry mechanism vacuuming options for your unique vertical transport. No pushy sales call, no waiting 24 hours for a callback. The price you see is the price you pay &mdash; locked in for 12 months, with no on-the-day upsells for chemistry or access equipment.",
  },
  {
    icon: UserCheck,
    step: "02",
    ...
    description:
      "We match you with a vetted, escalator-trained specialist in your postcode. They confirm the equipment type, frame material, coating register, and access constraints of your lift cars, flag any permanent scratches, coating degradation, or seal failure, and walk you through the pure-water and squeegee plan before any chemistry touches the surface &mdash; so there are no surprises on the day.",
  },
  {
    icon: CalendarCheck,
    step: "03",
    ...
    description:
      "Walk into a workplace that looks, feels, and stays fresh, backed by our 100% satisfaction guarantee. We finish every visit with a signed cleaning log, a defect-flagging report (step wear, handrail degradation, mechanism noise), a care-card update, and a re-clean reminder for the next visit. From &pound;180 per visit for a single escalator or lift car through to &pound;POA for multi-site shopping-centre and transport-hub contracts with 24/7 coverage.",
  },
];
...
const NEAR_ME_FAQS = [
  {
    ...
    a: "We cover 72+ towns and cities across Scotland &mdash; from Glasgow and Edinburgh in the Central Belt to Lerwick in Shetland and everywhere in between. Use the location grid above to find your town. If you don&rsquo;t see your postcode listed, call us &mdash; we add new coverage areas every month and may already have a escalator & lift cleaning specialist near you.",
  },
  {
    q: "How quickly can a local escalator specialist start?",
    a: "From quote to clean in under 48 hours for most postcodes in the Central Belt. For more remote areas (Highlands, Islands, Borders), allow 5-7 working days for technician routing and travel planning. Same-day starts are occasionally possible in Glasgow, Edinburgh, Stirling, and Dundee &mdash; call us to check availability. Full atrium high-reach programmes with HEPA dry mechanism vacuuming typically schedule 1-2 weeks out to allow for IRATA technician routing; multi-site estate programmes with BMU cradle access typically schedule 2-3 weeks out to align with building cradle availability.",
  },
  {
    q: "Will the technician travel to me, or do I need to bring the equipment to you?",
    a: "All escalator & lift and escalator and lift cleaning is performed on-site at your property &mdash; we never transport your lift cars anywhere. Our crews arrive in fully-equipped vans with Rosemor Rotomatic escalator cleaners, EN 14476 virucidal handrail sanitisation, professional Ettore and Unger squeegees, T-bar applicators, lint-free microfibre cloths, door-track maintenance kit, mirror restoration (lift car) chemistry, and IPAF/IRATA access certification where required. The only items we may need from you are: access to the building, any key-safe codes or alarm fobs, and a brief on operational hours and occupancy constraints.",
  },
  {
    q: "Do you have escalator specialists available in rural Scotland?",
  ...
  {
    q: "Can you clean the escalator & lifts in my Glasgow office out-of-hours?",
    a: "Absolutely &mdash; out-of-hours escalator & lift cleaning is one of our specialities, particularly across Glasgow IFSD, Edinburgh Exchange District, Aberdeen West End, and Dundee Waterfront corporate estates. We work overnight, weekend, or holiday periods &mdash; squeegee, dry-buff, frame detailing, and barrier removal all completed before trading resumes. We have worked overnight in occupied hotels (no guest disturbance &mdash; quiet pure-water technique, no chemical odour), retail units (no trading impact &mdash; overnight close), and offices (no staff impact &mdash; weekend clean). Operational disruption is the single biggest objection to escalator & lift cleaning, and we&rsquo;ve solved it.",
  },
  {
    q: "What&rsquo;s the difference between routine escalator maintenance, full escalator bank deep clean, and multi-site estate programmes near me?",
    a: "Routine escalator maintenance (&pound;180-&pound;280/visit) is the weekly or fortnightly top-up &mdash; squeegee of all internal lift cars, door handles sanitised, frames and tracks detailed, mirror restoration (lift car) if required. Full atrium high-reach clean (&pound;POA for multi-site) is the quarterly or annual cycle for high-reach vertical transport above 4m &mdash; EN 14476 virucidal handrail sanitisation for ground-to-65-feet access, HEPA dry mechanism vacuuming for surfaces above 65 feet, full frame and track detail, and a written defect report. External curtain-walling programmes (POA) are the annual cycle for multi-site estates &mdash; multi-team mobilisation, 24/7 coverage option, HTM 01-05 chemistry (clinical), specialist escalator machine, annual rate review, and performance bonus structure. We&rsquo;ll recommend the right approach at the free site survey.",
  },
];
...
export function EscalatorLiftCleaningNearMeHero() {
  return (
    <>
      {/* ============================================================ */}
      {/* SECTION 1 - Hero */}
      {/* H1: Escalator & Lift Cleaning Services Near Me in Scotland */}
      {/* ============================================================ */}
      <section className="relative overflow-hidden">
        <div className="absolute inset-0">
          <img
            src={IMG.heroWide}
            alt="Maundy Clean escalator & lift cleaning specialist squeegeeing a frameless internal escalator & lift to a speechlessly spotless finish in a Scottish commercial office"
        ...
        <div className="relative max-w-[1400px] mx-auto px-6 py-20 lg:py-28">
          ...
          >
            ...
            >
              Searching for &ldquo;escalator & lift cleaning near me&rdquo; or
              &ldquo;commercial escalator & lift cleaning near me&rdquo; in Scotland? Maundy
              Clean covers 72+ towns and cities across the Central Belt,
              Highlands, Borders, and Islands. Same PVG-checked standard, same
              pure-water de-ionised technology, same dedicated vertical transport
              ...
              &pound;POA per multi-site contract for a full escalator bank deep clean with
      ...
      {/* H2: Local Escalator & Lift Cleaning You Can Trust */}
      {/* ============================================================ */}
        ...
        <div className="max-w-[1100px] mx-auto px-6">
          ...
          >
            <span className="text-xs font-bold uppercase tracking-[0.18em] text-[var(--brand)] mb-3 inline-block">
              Local escalator &amp; lift cleaning &middot; Scotland-wide
            </span>
            <h2 className="font-display font-extrabold text-3xl lg:text-5xl text-[var(--ink)] tracking-tight mb-5">
              Local Escalator & Lift Cleaning You Can Trust
            </h2>
            <p className="text-base lg:text-lg text-[var(--ink)]/85 leading-[1.75]">
              Maundy Clean is a Scottish escalator & lift cleaning company built
              on the Maundy tradition of service and care. We don&rsquo;t
              operate as an impersonal national agency &mdash; we&rsquo;re a
              local specialist with PVG-checked escalator & lift crews living and
              working in your area. Whether you&rsquo;re searching for a
              escalator-lift programme in Glasgow&rsquo;s IFSD, a hotel-lobby
              balustrade restoration in Edinburgh&rsquo;s New Town, a
      ...
      {/* H2: Find Your Local Escalator & Lift Crew */}
      {/* ============================================================ */}
          ...
          <div className="grid lg:grid-cols-[1fr_1.6fr] gap-10 lg:gap-14 items-start">
            ...
            >
              ...
              <p className="text-base lg:text-lg text-[var(--muted-foreground)] leading-relaxed mb-6">
                Our network of vetted, PVG-checked escalator-lift specialists
                spans the entire country. From the Central Belt to the
                Highlands and Islands, we have a local professional ready to
                care for your commercial vertical transport. Browse by region below, or
              ...
              <div className="relative rounded-3xl overflow-hidden shadow-brand aspect-[4/3] bg-[var(--brand-dark)]">
                <img
                  src={IMG.scotlandMap}
                  alt="Map of Scotland showing Maundy Clean escalator &amp; lift cleaning coverage areas"
                ...
                <div className="absolute bottom-4 left-4 right-4 bg-white/95 backdrop-blur rounded-xl p-4">
                  ...
                  <p className="text-xs text-[var(--muted-foreground)] leading-relaxed">
                    Same PVG-checked escalator-lift specialists, same 100% satisfaction
      ...
      {/* ============================================================ */}
      {/* SECTION 4 - Why Maundy Clean for your local escalator-lift care */}
        ...
        <div className="max-w-[1400px] mx-auto px-6">
          ...
          >
            ...
            <p className="text-base lg:text-lg text-[var(--muted-foreground)] leading-relaxed">
              ...
              SafeContractor-approved escalator & lift specialists live in your area, know your
        ...
        <div className="max-w-[1400px] mx-auto px-6">
          ...
          >
            ...
            <p className="text-base lg:text-lg text-[var(--muted-foreground)] leading-relaxed max-w-2xl mx-auto">
              ...
              straightforward. Tell us about your escalator zones, equipment types,
              and access constraints, get matched with a local PVG-checked
              escalator-lift specialist, and enjoy a pristine workplace
      ...
      <section className="py-16 lg:py-24 bg-background">
        <div className="max-w-[1400px] mx-auto px-6">
          ...
          >
            ...
            <p className="text-base lg:text-lg text-[var(--muted-foreground)] leading-relaxed">
              Our escalator & lift cleaning is the perfect reset to combine with
              our other specialist services. Restore the vertical transport today, then
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              },
              {
                ...
                description:
                  "If you&rsquo;ve recently had construction work, our After Builders Clean removes the fine dust that settles on internal lift cars and escalator treads. Fine construction dust left on a freshly-cleaned escalator bank re-enters the air for months &mdash; we capture it at source before it becomes a long-term air-quality problem.",
          ...
          >
            <Link
              href="/services/escalator-lift-cleaning"
            ...
            >
              ...
              Explore the full escalator & lift &amp; vertical transport service
              <ArrowRight className="w-4 h-4" />
            </Link>
          </motion.div>
        </div>
      ...
      {/* ============================================================ */}
      {/* SECTION 7 - Final CTA */}
      {/* H2: Ready for an Escalator & Lift Crew Near You? */}
      {/* ============================================================ */}
        ...
        <div className="relative max-w-[1100px] mx-auto px-6 text-center">
          ...
          >
            <span className="text-xs font-bold uppercase tracking-[0.18em] text-[var(--gold)] mb-3 inline-block">
              Ready to book your local escalator & lift crew?
            </span>
            ...
            <p className="text-base lg:text-lg text-white/80 leading-relaxed max-w-2xl mx-auto mb-8">
              Get a fixed-price escalator & lift cleaning quote in 30 seconds.
              No pushy sales call, no waiting 24 hours for a callback.
              SafeContractor-approved escalator & lift specialists, Rosemor Rotomatic escalator cleaners,
              EN 14476 virucidal handrail sanitisation, IRATA-certified HEPA dry mechanism vacuuming,
              IPAF-certified Mobile Platform operation, ISO 14001 environmental
              compliance, and a 100% satisfaction guarantee on every visit
              &mdash; from &pound;14 per hour for routine escalator maintenance
              through to &pound;POA per multi-site contract for a full atrium high-reach
              clean with HEPA dry mechanism vacuuming. Coverage across 72+ Scottish towns.
            </p>
      ...
      <section className="py-16 lg:py-24 bg-background">
        <div className="max-w-4xl mx-auto px-6">
          ...
          >
            <span className="text-xs font-bold uppercase tracking-[0.18em] text-[var(--brand)] mb-3 inline-block">
              escalator & lift cleaning near me &middot; FAQ
            </span>
            <h2 className="font-display font-extrabold text-3xl lg:text-5xl text-[var(--ink)] tracking-tight mb-4">
              Frequently Asked Questions
            </h2>
            <p className="text-base lg:text-lg text-[var(--muted-foreground)] leading-relaxed max-w-2xl mx-auto">
              Straight answers to the questions our local escalator & lift
