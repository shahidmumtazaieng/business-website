...
const TRUST_PILLARS = [
  {
    icon: ShieldCheck,
    title: "Licensed Deodorisation Technicians",
    text: "Maundy Clean is fully qualified and accredited in forensic, trauma, and complex odour decontaminations. We never sub-contract or use unvetted labor.",
  },
  {
    icon: Users,
  ...
  {
    icon: Wind,
    title: "Total Air Quality Management",
    text: "From detailed site assessments to thermal fogging and advanced Ozone sterilisation, we provide comprehensive documentation and RAMS packages for every phase.",
  },
];

const NEAR_ME_FAQS = [
  {
    q: "How quickly can an odour removal crew respond?",
    a: "We operate a 24/7 hotline across Scotland and can typically dispatch a certified crew to any Central Belt location in under 2 hours, with slightly longer transit windows for rural Highlands and Border areas.",
  },
  {
    q: "Do your deodorisation services cover domestic residences?",
    a: "Yes. We work extensively with private homeowners, tenants, local authorities, and housing associations to restore residential properties, tenement flats, and estate buildings back to complete freshness.",
  },
  {
    q: "Are the cleaning products and methods safe for family and pets?",
    a: "Yes. While we must use advanced molecular neutralisers to eliminate complex organic compounds, we perform a thorough follow-up using certified non-toxic, child-safe, and pet-safe products to ensure the environment is fully safe for re-entry.",
  },
  {
    q: "How do you handle severe tobacco and pet odours?",
    a: "We ignore standard domestic spray masking and target the molecular source using industrial-grade ozone treatments, deep hot water extraction, and thermal foggers. This breaks down the odour-causing compounds trapped deep in fabrics and porous materials.",
  },
];

export function OdourRemovalNearMeHero() {
    ...
    <div className="bg-background text-[var(--ink)]">
      ...
      <section className="relative min-h-[460px] flex items-center justify-center bg-[var(--brand-dark)] text-white overflow-hidden py-16">
        <div className="absolute inset-0 z-0">
          ...
          <img
            src="https://maundyclean.sirv.com/Images/WhatsApp%20Image%202026-07-22%20at%208.26.01%20PM.jpeg"
            alt="Odour Removal Near Me"
        ...
        <div className="relative z-10 max-w-[1000px] mx-auto px-6 text-center space-y-6">
          <div className="inline-flex items-center gap-2 bg-emerald-500/10 border border-emerald-500/30 text-emerald-400 text-xs font-bold uppercase tracking-wider px-3 py-1 rounded-full">
          ...
          <p className="text-base sm:text-lg text-white/95 max-w-3xl mx-auto leading-relaxed font-medium">
            Find certified, discreet, and HSE-compliant odour elimination and air quality restoration crews in your local Scottish area. On-site within 2 hours across the Central Belt.
          </p>
        ...
        <div className="max-w-[1200px] mx-auto px-6 space-y-12">
          <div className="text-center max-w-3xl mx-auto space-y-4">
            ...
            <p className="text-sm text-[var(--muted-foreground)] leading-relaxed">
              We operate response units based out of four regional depots. Select your location from the lists below to read local dispatch details, contact phone lines, or lock in service agreements.
            </p>
          </div>
        ...
        <div className="max-w-[1200px] mx-auto px-6 space-y-12">
          <div className="text-center max-w-3xl mx-auto space-y-4">
            <h2 className="font-display text-3xl font-extrabold tracking-tight leading-tight">
              A Higher Standard of Air Decontamination
            </h2>
            <p className="text-sm text-[var(--muted-foreground)] leading-relaxed">
              Severe odour neutralisation requires certified specialists. At Maundy Clean, our technical staff are rigorously trained and equipped for any sensitive environment.
            </p>
          </div>
        ...
        <div className="max-w-[1200px] mx-auto px-6 space-y-12">
          <div className="text-center max-w-3xl mx-auto space-y-4">
            ...
            <p className="text-sm text-[var(--muted-foreground)]">
              Restoring properties from biological or environmental risk involves sequential steps. Discover our adjacent cleaning programs.
            </p>
          </div>
      ...
      <section className="py-16 bg-[var(--brand-dark)] text-white text-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-[800px] mx-auto px-6 space-y-6">
          <h2 className="font-display text-3xl font-extrabold">
            Request Local Odour Removal Dispatch
          </h2>
