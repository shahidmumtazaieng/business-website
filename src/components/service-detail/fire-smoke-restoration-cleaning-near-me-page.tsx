...
// Hero Section
// ============================================================
export function FireSmokeRestorationCleaningNearMeHero() {
  return (
    <section className="relative min-h-[460px] flex items-center justify-center bg-[var(--brand-dark)] text-white overflow-hidden py-16">
      <div className="absolute inset-0 z-0">
        ...
        <img
          src={IMG.hero}
          alt="Fire & Smoke Restoration Cleaning Scotland Near Me"
      ...
      <div className="relative z-10 max-w-[1000px] mx-auto px-6 text-center space-y-6">
        ...
        <h1 className="font-display text-4xl sm:text-5xl font-extrabold tracking-tight leading-[1.15]">
          Fire Damage Restoration & Smoke Cleaning Services Near Me
        </h1>
        <p className="text-base sm:text-lg text-white/90 max-w-2xl mx-auto leading-relaxed">
          Localised emergency soot removal and carbon restoration specialists serving Glasgow, Edinburgh, Aberdeen, Dundee, and all surrounding Scottish areas.
        </p>
...
// ============================================================
export function FireSmokeRestorationCleaningNearMeGrid() {
      ...
      <div className="max-w-[1200px] mx-auto px-6 space-y-12">
        <div className="text-center max-w-3xl mx-auto space-y-4">
          ...
          <h2 className="font-display text-3xl sm:text-4xl font-extrabold tracking-tight">
            Our Certified Local Fire Damage Restoration Coverage Areas
          </h2>
                    ...
                    >
                      <div className="space-y-4">
                        ...
                        <p className="text-xs text-[var(--muted-foreground)] leading-relaxed">
                          Professional soot cleaning, carbon neutralization, air scrubbing, and comprehensive post-fire environmental restoration services for residential and commercial spaces in {city.city}.
                        </p>
...
// ============================================================
export function FireSmokeRestorationCleaningNearMeDispatch() {
  return (
...
// ============================================================
export function FireSmokeRestorationCleaningNearMeCta() {
  return (
      ...
      <div className="relative z-10 max-w-[900px] mx-auto px-6 text-center space-y-6">
        ...
        <div className="flex flex-wrap justify-center gap-4 pt-4">
          ...
          <Button
            ...
            asChild
          >
            <Link href="/services/fire-smoke-restoration-cleaning">View Service Details</Link>
          </Button>
        </div>
...
const FAQ_ITEMS: FaqItem[] = [
  {
    q: "How quickly can your local post-fire restoration team arrive?",
  ...
  },
  {
    ...
    a: "Yes. All our technicians are fully vetted, background-checked, and highly trained in HSE fire guidelines and COSHH compliance. We carry £5M public liability insurance as standard.",
  },
  {
    q: "Can you remove the smell of smoke completely?",
    a: "Absolutely. As part of our professional service, we utilize advanced ozone generators and thermal foggers to neutralize deeply ingrained odor particles, ensuring 100% molecular odor removal.",
  },
];

export function FireSmokeRestorationCleaningNearMeFaq() {
      ...
      <div className="max-w-[800px] mx-auto px-6 space-y-12">
        <div className="text-center space-y-4">
          ...
          <h2 className="font-display text-3xl font-extrabold tracking-tight leading-tight">
            Common Local Fire & Smoke Restoration Questions
          </h2>
        </div>
