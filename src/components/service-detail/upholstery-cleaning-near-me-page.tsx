...
const IMG = {
  heroWide:
    "https://maundyclean.sirv.com/Images/WhatsApp%20Image%202026-07-21%20at%207.37.27%20PM.jpeg",
  scotlandMap:
...
const HERO_BADGES = [
  ...
  { icon: Shield, label: "Fully Insured & Guaranteed" },
...
const TRUST_PILLARS = [
  {
    ...
    description:
      "Trust is essential when inviting someone to care for your delicate furnishings. Unlike gig-economy cleaning apps, we only employ our own staff. The same vetted, uniformed, and background-checked technicians who manage your regular house cleaning are the ones performing your intensive fabric care. Continuity matters when the stakes are a velvet suite or a leather heirloom.",
  },
  {
    icon: Award,
    title: "Vocationally Trained, Fibre-Matched Technicians",
    description:
  ...
  {
    icon: Leaf,
    title: "Safe for Families, Pets, and Delicate Fabrics",
    description:
      "We use only certified child-safe and pet-safe products with EU Ecolabel or WoolSafe approval. Our cleaning methods remove germs, dust mites, and unwanted odours without leaving behind harsh chemical residues that re-soil the fabric and trigger respiratory sensitivity &mdash; safer for crawling babies, sleeping pets, and allergy sufferers alike.",
  },
  {
    icon: Gem,
    title: "Fully Insured & 100% Re-Clean Guaranteed",
    description:
      "Every technician is Disclosure Scotland PVG-checked, we hold &pound;5m public liability cover, and we offer a free re-clean within 24 to 48 hours if you are not 100% satisfied. We are a registered Scottish company &mdash; not a gig-economy agency &mdash; and the Maundy Clean standard applies on every visit, from Glasgow to Lerwick.",
  },
];
...
const BOOKING_STEPS = [
  {
    ...
    description:
      "Tell us about your sofas, armchairs, and dining chairs and receive a fixed-price quote in under a minute. No pushy sales call, no waiting 24 hours for a callback. The price you see is the price you pay &mdash; locked in, fully transparent, with no on-the-day upsells for spotters or fabric protector.",
  },
  {
    icon: UserCheck,
    step: "02",
    ...
    description:
      "We match you with a vetted, fibre-matched technician in your postcode. They confirm the fabric type, flag any permanent stains, and walk you through the cleaning plan before any chemistry touches the weave &mdash; so there are no surprises on the day.",
  },
  {
    icon: CalendarCheck,
    step: "03",
    title: "A Healthier, Fresher Home",
    description:
      "Walk into a room that looks, feels, and smells fresh, backed by our 100% satisfaction guarantee. Most upholstery is touch-dry in 2 to 4 hours; we loan air-movers free of charge on full-suite cleans. You receive a written care card and a 12-month re-clean reminder at the locked-in rate.",
  },
];
...
const NEAR_ME_FAQS = [
  ...
  {
    q: "Will the technician clean my sofas at home or take them away?",
    a: "All upholstery cleaning is performed in place at your home &mdash; we never take your furniture off-site. Our hot-water extraction equipment is fully mobile and designed for domestic use. The technician arrives in a fully equipped van with all chemistry, spotters, and extraction gear needed to clean your sofas, armchairs, and dining chairs right where they sit.",
  },
  {
    q: "Do you have upholstery cleaning technicians available in rural Scotland?",
    a: "Yes. We cover rural Scotland including Perthshire, Angus, Fife, the Borders, Argyll, Aberdeenshire, and parts of the Highlands. For very remote properties (Islands, far North), we may operate on a minimum-item basis or schedule combined visits with neighbouring properties to keep travel costs down. Call us to discuss your specific location.",
  },
  {
    q: "Can you clean the upholstery in my holiday let or short-term rental?",
    a: "Absolutely. Many of our clients use us for holiday lets, short-term rentals, and second homes across Scotland. We provide emergency turnover cleans between guests, periodic deep cleans during void periods, and full suite rejuvenation for premium short-term lets. Visit our Holiday Let Turnover page for more detail on combined turnover + upholstery extraction packages.",
  },
  {
    q: "What&rsquo;s the difference between upholstery cleaning and sofa cleaning near me?",
    a: "They are the same service under two names. Upholstery cleaning is the technical term covering sofas, armchairs, dining chairs, ottomans, and any other fabric-covered furniture. Sofa cleaning is the term most customers search for. We clean all upholstered furniture with the same fibre-matched chemistry, the same extraction equipment, and the same 100% re-clean guarantee &mdash; whether you book a single armchair or a full leather suite.",
  },
];
...
export function UpholsteryNearMeHero() {
  return (
    <>
      {/* ============================================================ */}
      {/* SECTION 1 — Hero */}
      {/* H1: Upholstery & Sofa Cleaning Near Me in Scotland */}
      {/* ============================================================ */}
        ...
        <div className="relative max-w-[1400px] mx-auto px-6 py-20 lg:py-28">
          ...
          >
            ...
            >
              ...
              72+ Scottish towns · Local fibre-matched technicians · Same crew every visit
            </motion.div>
            ...
            >
              ...
              guarantee, same dedicated technician &mdash; wherever your home happens to be. From
              £69/item.
            </motion.p>
      ...
      {/* H2: Local Upholstery & Sofa Cleaning You Can Trust */}
      {/* ============================================================ */}
        ...
        <div className="max-w-[1100px] mx-auto px-6">
          ...
          >
            <span className="text-xs font-bold uppercase tracking-[0.18em] text-[var(--brand)] mb-3 inline-block">
              Local upholstery &amp; sofa cleaning · Scotland-wide
            </span>
            <h2 className="font-display font-extrabold text-3xl lg:text-5xl text-[var(--ink)] tracking-tight mb-5">
              Local Upholstery &amp; Sofa Cleaning You Can Trust
            </h2>
            <p className="text-base lg:text-lg text-[var(--ink)]/85 leading-[1.75]">
              Maundy Clean is a Scottish upholstery &amp; sofa cleaning company built on the Maundy
              tradition of service and care. We don&rsquo;t operate as an impersonal national agency
              &mdash; we&rsquo;re a local specialist with fibre-matched technicians living and
              working in your area. Whether you&rsquo;re searching for sofa deep cleaning in
              Glasgow&rsquo;s West End, leather conditioning in Edinburgh&rsquo;s New Town, velvet
              upholstery care in Aberdeen&rsquo;s suburbs, or pet-stain removal anywhere in between,
              we assign a vetted, PAYE-employed professional that stays with you for the long run.
      ...
      {/* H2: Find Your Local Upholstery Cleaner */}
      {/* ============================================================ */}
          ...
          <div className="grid lg:grid-cols-[1fr_1.6fr] gap-10 lg:gap-14 items-start">
            ...
            >
              ...
              <p className="text-base lg:text-lg text-[var(--muted-foreground)] leading-relaxed mb-6">
                Our network of vetted, fibre-matched upholstery cleaning technicians spans the entire
                country. From the Central Belt to the Highlands and Islands, we have a local
                professional ready to restore the fabrics in your home. Browse by region below, or
              ...
              <div className="relative rounded-3xl overflow-hidden shadow-brand aspect-[4/3] bg-[var(--brand-dark)]">
                ...
                <div className="absolute bottom-4 left-4 right-4 bg-white/95 backdrop-blur rounded-xl p-4">
                  ...
                  <p className="text-xs text-[var(--muted-foreground)] leading-relaxed">
                    Same fibre-matched technicians, same 100% re-clean guarantee &mdash; from
                    Glasgow to Lerwick.
                  </p>
                </div>
              </div>
      ...
      {/* ============================================================ */}
      {/* SECTION 4 — Why Maundy Clean for your local upholstery cleaning */}
        ...
        <div className="max-w-[1400px] mx-auto px-6">
          ...
          >
            ...
            <p className="text-base lg:text-lg text-[var(--muted-foreground)] leading-relaxed">
              We&rsquo;re a local specialist, not an impersonal national agency. Our fibre-matched
        ...
        <div className="max-w-[1400px] mx-auto px-6">
          ...
          >
            ...
            <p className="text-base lg:text-lg text-[var(--muted-foreground)] leading-relaxed max-w-2xl mx-auto">
              ...
              Tell us about your sofas and armchairs, get matched with a local fibre-matched
              technician, and enjoy a healthier, fresher home &mdash; no friction, no waiting, no
              surprises.
            </p>
          </motion.div>
      ...
      <section className="py-16 lg:py-24 bg-background">
        <div className="max-w-[1400px] mx-auto px-6">
          ...
          >
            ...
            <p className="text-base lg:text-lg text-[var(--muted-foreground)] leading-relaxed">
              Our upholstery &amp; sofa deep cleaning is the perfect reset to combine with our other
              specialist services. Restore the fabrics today, then keep them pristine with the right
            ...
            {[
              {
                ...
                description:
                  "After your fabrics are restored, keep them pristine with a recurring home cleaning schedule &mdash; weekly or fortnightly. Edge-to-edge vacuuming and immediate spill response are the single biggest factors in how long a deep clean lasts.",
              ...
              },
              {
                ...
                description:
                  "Moving homes? Our End of Tenancy Cleaning includes a Deposit-Back Guarantee and professional sofa care as standard. We work to the letting agent&rsquo;s inventory and come back free of charge if anything is flagged.",
              ...
              },
              {
                ...
                description:
                  "If you&rsquo;re putting a house up for sale, a Deep House Cleaning combined with upholstery rejuvenation creates the WOW factor that attracts buyers and lifts offers. Stale odours and tired sofas are the single biggest turn-off at viewings.",
              ...
              },
              {
                ...
                description:
                  "Book a One-Off Spring Clean for a comprehensive top-to-bottom refresh of your entire home &mdash; skirtings, light fittings, behind appliances, and the upholstery extraction that pulls a winter&rsquo;s worth of grime from the weave.",
      ...
      {/* ============================================================ */}
      {/* SECTION 7 — Final CTA */}
      {/* H2: Ready for an Upholstery Cleaner Near You? */}
      {/* ============================================================ */}
        ...
        <div className="relative max-w-[1100px] mx-auto px-6 text-center">
          ...
          >
            <span className="text-xs font-bold uppercase tracking-[0.18em] text-[var(--gold)] mb-3 inline-block">
              Ready to book your local upholstery cleaner?
            </span>
            <h2 className="font-display font-extrabold text-3xl lg:text-5xl text-white tracking-tight mb-4">
              Ready for an Upholstery Cleaner Near You?
            </h2>
            <p className="text-base lg:text-lg text-white/80 leading-relaxed max-w-2xl mx-auto mb-8">
              Get a fixed-price upholstery &amp; sofa cleaning quote in 30 seconds. No pushy sales
              call, no waiting 24 hours for a callback. Fibre-matched chemistry, child &amp; pet-safe
              products, a 100% re-clean guarantee, and a written aftercare card with every visit
              &mdash; from £69/item. Coverage across 72+ Scottish towns.
            </p>
      ...
      <section className="py-16 lg:py-24 bg-background">
        <div className="max-w-4xl mx-auto px-6">
          ...
          >
            <span className="text-xs font-bold uppercase tracking-[0.18em] text-[var(--brand)] mb-3 inline-block">
              Upholstery &amp; sofa cleaning near me · FAQ
            </span>
            <h2 className="font-display font-extrabold text-3xl lg:text-5xl text-[var(--ink)] tracking-tight mb-4">
              Frequently Asked Questions
            </h2>
            <p className="text-base lg:text-lg text-[var(--muted-foreground)] leading-relaxed max-w-2xl mx-auto">
              Straight answers to the questions our local upholstery &amp; sofa cleaning clients ask
