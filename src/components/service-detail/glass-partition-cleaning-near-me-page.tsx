...
const IMG = {
  heroWide:
    "https://maundyclean.sirv.com/Images/WhatsApp%20Image%202026-07-22%20at%205.53.31%20PM.jpeg",
  scotlandMap:
...
const TRUST_PILLARS = [
  {
    icon: Users,
    title: "The Same Trusted Glass Care Crew Every Time",
    description:
      "Unlike gig-economy cleaning apps, we only employ our own staff. The same vetted, uniformed, and background-checked glazing specialists who manage your regular glass partition cleaning are the ones performing your pure-water squeegee work, Reach-and-Wash pole cleaning, and Rope Access high-reach programmes. Continuity matters when the stakes are a Glasgow IFSD corporate meeting-room partition, an Edinburgh retail-chain balustrade, or an Aberdeen hotel-lobby mirrored feature-wall &mdash; we don&rsquo;t send rotating crews of strangers to your property.",
  },
  {
    icon: Droplets,
    title: "Pure-Water De-Ionised Systems & Reach-and-Wash Poles",
    description:
      "Our glazing specialists understand every variety of commercial internal glass &mdash; from annealed and toughened partitions through laminated, mirrored, low-E coated, anti-reflective coated, and privacy-filmed panels. We identify the glass type, the coating register, and the access constraints before we touch the surface, then apply the right protocol: pure de-ionised water with a T-bar applicator, professional Ettore or Unger squeegee, lint-free microfibre edge detailing, Reach-and-Wash telescopic poles up to 65 feet for high-reach internal and external glazing, and Rope Access or Mobile Platform operation for surfaces exceeding 65 feet. Wrong chemistry on coated glass equals permanent damage &mdash; we refuse to clean what we cannot safely treat.",
  },
  {
    icon: Mountain,
    title: "Rope Access, Mobile Platforms & Cradle Systems",
    description:
      "For surfaces exceeding standard heights, we provide specialist teams trained in Rope Access (IRATA-certified), Mobile Platforms (IPAF-certified cherry-picker and scissor-lift), and BMU (Building Maintenance Unit) cradle operation for buildings with permanent cradle systems. Carbon-fibre telescopic Reach-and-Wash poles for high-reach internal atrium glazing up to 65 feet from ground level &mdash; no ladders, no MEWP, no scaffolding. All cleaning solutions are certified non-toxic, biodegradable, child-safe, and surface-safe &mdash; pure de-ionised water is COSHH-exempt. The glass is safe for staff and visitors to walk past mid-clean.",
  },
  {
    icon: Award,
    title: "Fully Insured & 100% Satisfaction Guaranteed",
    description:
      "Every glazing specialist is Disclosure Scotland PVG-checked, we hold &pound;5m public liability cover, and we offer a free re-clean within 24 to 48 hours if you are not 100% satisfied. We are a registered Scottish company &mdash; not a gig-economy agency &mdash; and the Maundy Clean standard applies on every visit. From &pound;14 per hour for routine partition maintenance through to &pound;395 per visit for a full atrium high-reach clean with Rope Access, with a written defect report on every visit and 12-month rate-lock on every contract.",
  },
];
...
const BOOKING_STEPS = [
  {
    icon: Zap,
    step: "01",
    title: "Free Site Survey & Glass Audit",
    description:
      "Tell us about your glass zones, partition types, and access constraints &mdash; and receive a fixed-price glass-care quote in under a minute. Our team will advise on the best specialist squeegee, Reach-and-Wash, or Rope Access options for your unique glazing. No pushy sales call, no waiting 24 hours for a callback. The price you see is the price you pay &mdash; locked in for 12 months, with no on-the-day upsells for chemistry or access equipment.",
  },
  {
    icon: UserCheck,
    step: "02",
  ...
  },
  {
    ...
    description:
      "Walk into a workplace that looks, feels, and stays fresh, backed by our 100% satisfaction guarantee. We finish every visit with a flashlight inspection (the same test your facilities manager uses), a defect-flagging report, a care-card update, and a re-clean reminder for the next visit. From &pound;14 per hour for routine partition maintenance through to &pound;395 per visit for a full atrium high-reach clean with Rope Access.",
  },
];
...
const NEAR_ME_FAQS = [
  {
    ...
    a: "We cover 72+ towns and cities across Scotland &mdash; from Glasgow and Edinburgh in the Central Belt to Lerwick in Shetland and everywhere in between. Use the location grid above to find your town. If you don&rsquo;t see your postcode listed, call us &mdash; we add new coverage areas every month and may already have a glass-partition cleaning specialist near you.",
  },
  {
    q: "How quickly can a local glass specialist start?",
    a: "From quote to clean in under 48 hours for most postcodes in the Central Belt. For more remote areas (Highlands, Islands, Borders), allow 5-7 working days for technician routing and travel planning. Same-day starts are occasionally possible in Glasgow, Edinburgh, Stirling, and Dundee &mdash; call us to check availability. Full atrium high-reach programmes with Rope Access typically schedule 1-2 weeks out to allow for IRATA technician routing; external curtain-walling programmes with BMU cradle access typically schedule 2-3 weeks out to align with building cradle availability.",
  },
  {
    q: "Will the technician travel to me, or do I need to bring the glass to you?",
    a: "All glass partition and internal glazing cleaning is performed on-site at your property &mdash; we never transport your partitions anywhere. Our crews arrive in fully-equipped vans with pure-water de-ionised systems, Reach-and-Wash telescopic poles, professional Ettore and Unger squeegees, T-bar applicators, lint-free microfibre cloths, frame and track detailing kit, mirror restoration chemistry, and IPAF/IRATA access certification where required. The only items we may need from you are: access to the building, any key-safe codes or alarm fobs, and a brief on operational hours and occupancy constraints.",
  },
  {
    q: "Do you have glass specialists available in rural Scotland?",
  ...
  {
    q: "Can you clean the glass partitions in my Glasgow office out-of-hours?",
    a: "Absolutely &mdash; out-of-hours glass partition cleaning is one of our specialities, particularly across Glasgow IFSD, Edinburgh Exchange District, Aberdeen West End, and Dundee Waterfront corporate estates. We work overnight, weekend, or holiday periods &mdash; squeegee, dry-buff, frame detailing, and barrier removal all completed before trading resumes. We have worked overnight in occupied hotels (no guest disturbance &mdash; quiet pure-water technique, no chemical odour), retail units (no trading impact &mdash; overnight close), and offices (no staff impact &mdash; weekend clean). Operational disruption is the single biggest objection to glass partition cleaning, and we&rsquo;ve solved it.",
  },
  {
    q: "What&rsquo;s the difference between routine partition maintenance, full atrium high-reach clean, and external curtain-walling programmes near me?",
    a: "Routine partition maintenance (&pound;14-&pound;18/hour) is the weekly or fortnightly top-up &mdash; squeegee of all internal partitions, door handles sanitised, frames and tracks detailed, mirror restoration if required. Full atrium high-reach clean (&pound;395+ per visit) is the quarterly or annual cycle for high-reach internal glazing above 4m &mdash; Reach-and-Wash telescopic poles for ground-to-65-feet access, Rope Access for surfaces above 65 feet, full frame and track detail, and a written defect report. External curtain-walling programmes (POA) are the annual cycle for the building perimeter &mdash; Reach-and-Wash or BMU cradle access, full curtain-wall clean, fascia refresh, gutter clear, and downpipe clean. We&rsquo;ll recommend the right approach at the free site survey.",
  },
];
...
export function GlassPartitionCleaningNearMeHero() {
  return (
    <>
      {/* ============================================================ */}
      {/* SECTION 1 - Hero */}
      {/* H1: Glass Partition Cleaning Services Near Me in Scotland */}
      {/* ============================================================ */}
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-[1400px] mx-auto px-6 py-20 lg:py-28">
          ...
          >
            ...
            >
              Glass Partition Cleaning Services Near Me in Scotland
            </motion.h1>
            ...
            >
              ...
              &ldquo;commercial glass cleaning near me&rdquo; in Scotland? Maundy
              Clean covers 72+ towns and cities across the Central Belt,
              Highlands, Borders, and Islands. Same PVG-checked standard, same
              pure-water de-ionised technology, same dedicated glazing
              specialist &mdash; wherever your property happens to be. From
              &pound;14 per hour for routine partition maintenance through to
              &pound;395 per visit for a full atrium high-reach clean with
              Rope Access.
            </motion.p>
      ...
      {/* H2: Local Glass Partition Cleaning You Can Trust */}
      {/* ============================================================ */}
        ...
        <div className="max-w-[1100px] mx-auto px-6">
          ...
          >
            <span className="text-xs font-bold uppercase tracking-[0.18em] text-[var(--brand)] mb-3 inline-block">
              Local glass partition &amp; internal glazing cleaning &middot; Scotland-wide
            </span>
            <h2 className="font-display font-extrabold text-3xl lg:text-5xl text-[var(--ink)] tracking-tight mb-5">
              Local Glass Partition Cleaning You Can Trust
            </h2>
            <p className="text-base lg:text-lg text-[var(--ink)]/85 leading-[1.75]">
              Maundy Clean is a Scottish glass partition cleaning company built
              on the Maundy tradition of service and care. We don&rsquo;t
              operate as an impersonal national agency &mdash; we&rsquo;re a
              local specialist with PVG-checked glazing crews living and
              working in your area. Whether you&rsquo;re searching for a
              glass-partition programme in Glasgow&rsquo;s IFSD, a hotel-lobby
          ...
          >
            {[
              { label: "Glass types covered", value: "All types" },
      ...
      {/* H2: Find Your Local Glass-Partition Crew */}
      {/* ============================================================ */}
          ...
          <div className="grid lg:grid-cols-[1fr_1.6fr] gap-10 lg:gap-14 items-start">
            ...
            >
              ...
              <p className="text-base lg:text-lg text-[var(--muted-foreground)] leading-relaxed mb-6">
                Our network of vetted, PVG-checked glass-partition specialists
                spans the entire country. From the Central Belt to the
                Highlands and Islands, we have a local professional ready to
                care for your commercial glazing. Browse by region below, or
              ...
              <div className="relative rounded-3xl overflow-hidden shadow-brand aspect-[4/3] bg-[var(--brand-dark)]">
                ...
                <div className="absolute bottom-4 left-4 right-4 bg-white/95 backdrop-blur rounded-xl p-4">
                  ...
                  <p className="text-xs text-[var(--muted-foreground)] leading-relaxed">
                    Same PVG-checked glass-partition specialists, same 100% satisfaction
      ...
      {/* ============================================================ */}
      {/* SECTION 4 - Why Maundy Clean for your local glass-partition care */}
        ...
        <div className="max-w-[1400px] mx-auto px-6">
          ...
          >
            ...
            <p className="text-base lg:text-lg text-[var(--muted-foreground)] leading-relaxed">
              ...
              PVG-checked glazing specialists live in your area, know your
        ...
        <div className="max-w-[1400px] mx-auto px-6">
          ...
          >
            ...
            <p className="text-base lg:text-lg text-[var(--muted-foreground)] leading-relaxed max-w-2xl mx-auto">
              ...
              straightforward. Tell us about your glass zones, partition types,
              and access constraints, get matched with a local PVG-checked
              glass-partition specialist, and enjoy a pristine workplace
      ...
      <section className="py-16 lg:py-24 bg-background">
        <div className="max-w-[1400px] mx-auto px-6">
          ...
          >
            ...
            <p className="text-base lg:text-lg text-[var(--muted-foreground)] leading-relaxed">
              Our glass partition cleaning is the perfect reset to combine with
              our other specialist services. Restore the glazing today, then
            ...
            {[
              {
                ...
                description:
                  "After your partitions are restored, keep them pristine with a recurring home cleaning schedule &mdash; weekly or fortnightly. Our same trusted crew maintains your glazing with pure-water, surface-safe products as part of every visit, catching wear patterns early and extending the life of the finish.",
              ...
              },
              {
                ...
                description:
                  "If you&rsquo;ve recently had construction work, our After Builders Clean removes the fine dust that settles on internal partitions and frames. Fine construction dust left on a freshly-cleaned glass wall re-enters the air for months &mdash; we capture it at source before it becomes a long-term air-quality problem.",
          ...
          >
            ...
            >
              ...
              Explore the full glass partition &amp; internal glazing service
              <ArrowRight className="w-4 h-4" />
            </Link>
          </motion.div>
        </div>
      ...
      {/* ============================================================ */}
      {/* SECTION 7 - Final CTA */}
      {/* H2: Ready for a Glass-Partition Crew Near You? */}
      {/* ============================================================ */}
        ...
        <div className="relative max-w-[1100px] mx-auto px-6 text-center">
          ...
          >
            <span className="text-xs font-bold uppercase tracking-[0.18em] text-[var(--gold)] mb-3 inline-block">
              Ready to book your local glass-partition crew?
            </span>
            ...
            <p className="text-base lg:text-lg text-white/80 leading-relaxed max-w-2xl mx-auto mb-8">
              Get a fixed-price glass partition cleaning quote in 30 seconds.
              No pushy sales call, no waiting 24 hours for a callback.
              PVG-checked glazing specialists, pure-water de-ionised systems,
              Reach-and-Wash telescopic poles, IRATA-certified Rope Access,
              ...
              &mdash; from &pound;14 per hour for routine partition maintenance
              through to &pound;395 per visit for a full atrium high-reach
              clean with Rope Access. Coverage across 72+ Scottish towns.
            </p>
      ...
      <section className="py-16 lg:py-24 bg-background">
        <div className="max-w-4xl mx-auto px-6">
          ...
          >
            <span className="text-xs font-bold uppercase tracking-[0.18em] text-[var(--brand)] mb-3 inline-block">
              glass partition cleaning near me &middot; FAQ
            </span>
            <h2 className="font-display font-extrabold text-3xl lg:text-5xl text-[var(--ink)] tracking-tight mb-4">
              Frequently Asked Questions
            </h2>
            <p className="text-base lg:text-lg text-[var(--muted-foreground)] leading-relaxed max-w-2xl mx-auto">
              Straight answers to the questions our local glass partition
