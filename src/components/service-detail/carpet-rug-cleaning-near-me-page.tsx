...
const TRUST_PILLARS = [
  ...
  {
    icon: Leaf,
    title: "Safe for Families, Pets, and Delicate Piles",
    description:
      "We use only certified child-safe and pet-safe products with EU Ecolabel or WoolSafe approval. Our cleaning methods remove germs, dust mites, and unwanted odours without leaving behind harsh chemical residues that re-soil the pile and trigger respiratory sensitivity &mdash; safer for your family and your fabrics.",
  },
  {
    icon: Award,
    title: "Fully Insured & 100% Re-Clean Guaranteed",
    description:
      "Every technician is Disclosure Scotland PVG-checked, we hold £5m public liability cover, and we offer a free re-clean within 24 to 48 hours if you are not 100% satisfied. We are a registered Scottish company &mdash; not a gig-economy agency &mdash; and the Maundy Clean standard applies on every visit.",
  },
];
...
const BOOKING_STEPS = [
  {
    ...
    description:
      "Tell us about your carpets and rugs and receive a fixed-price quote in under a minute. No pushy sales call, no waiting 24 hours for a callback. The price you see is the price you pay &mdash; locked in, fully transparent, with no on-the-day upsells for spotters or air-movers.",
  },
  {
    icon: UserCheck,
    step: "02",
    ...
    description:
      "We match you with a vetted NCCA-certified technician in your postcode. They confirm fibre type, flag any permanent stains, and walk you through the cleaning plan before any chemistry touches the pile &mdash; so there are no surprises on the day.",
  },
  {
    icon: CalendarCheck,
    step: "03",
    ...
    description:
      "Walk onto floors that look, feel, and smell fresh, backed by our 100% satisfaction guarantee. Most carpets are touch-dry in 3 to 5 hours; we loan air-movers free for 24 hours on whole-home cleans. You receive a written care card and a 12-month re-clean reminder at the locked-in rate.",
  },
];
...
const NEAR_ME_FAQS = [
  ...
  {
    q: "How quickly can a local carpet cleaning technician start?",
  ...
  {
    q: "Will the technician travel to me, or do I need to bring my rugs to you?",
    a: "Both options are available. Synthetic and modern wool rugs are cleaned in place at your home with hot-water extraction. Hand-knotted Persian, Oriental, silk, and antique rugs are transported to our Glasgow workshop for full-immersion bathing &mdash; the only safe method for pieces that may bleed, shrink, or fringe-tangle. We collect and deliver within 25 miles at no charge.",
  },
  {
    q: "Do you have carpet cleaning technicians available in rural Scotland?",
    a: "Yes. We cover rural Scotland including Perthshire, Angus, Fife, the Borders, Argyll, Aberdeenshire, and parts of the Highlands. For very remote properties (Islands, far North), we may operate on a minimum-room basis or schedule combined visits with neighbouring properties to keep travel costs down. Call us to discuss your specific location.",
  },
  {
    q: "Can you clean the carpets in my holiday let or short-term rental?",
    a: "Absolutely. Many of our clients use us for holiday lets, short-term rentals, and second homes across Scotland. We provide emergency turnover cleans between guests, periodic deep cleans during void periods, and full rug rejuvenation for premium short-term lets. Visit our Holiday Let Turnover page for more detail on combined turnover + extraction packages.",
  },
  {
    q: "What&rsquo;s the difference between carpet cleaning and rug cleaning near me?",
    a: "Carpet cleaning covers wall-to-wall fitted carpets in your home &mdash; we clean these in place with hot-water extraction. Rug cleaning covers loose rugs that can be rolled or moved &mdash; synthetic and modern wool rugs are cleaned in place, but hand-knotted Persian, Oriental, silk, and antique rugs are taken to our Glasgow workshop for full-immersion bathing. If you have both, we typically do the fitted carpets on-site and collect any delicate rugs for workshop cleaning in the same visit.",
  },
];
...
export function CarpetRugNearMeHero() {
  return (
    <>
      ...
      {/* H2: Local Carpet & Rug Cleaning You Can Trust */}
      {/* ============================================================ */}
        ...
        <div className="max-w-[1100px] mx-auto px-6">
          ...
          >
            ...
            <h2 className="font-display font-extrabold text-3xl lg:text-5xl text-[var(--ink)] tracking-tight mb-5">
              Local Carpet &amp; Rug Cleaning You Can Trust
            </h2>
            <p className="text-base lg:text-lg text-[var(--ink)]/85 leading-[1.75]">
              ...
              &mdash; we&rsquo;re a local specialist with NCCA-certified technicians living and
              working in your area. Whether you&rsquo;re searching for hot-water extraction in
              Glasgow&rsquo;s West End, Persian rug bathing in Edinburgh&rsquo;s New Town, wool
              carpet cleaning in Aberdeen&rsquo;s suburbs, or pet-stain removal anywhere in between,
          ...
          <div className="grid lg:grid-cols-[1fr_1.6fr] gap-10 lg:gap-14 items-start">
            ...
            >
              ...
              <p className="text-base lg:text-lg text-[var(--muted-foreground)] leading-relaxed mb-6">
                Our network of vetted, NCCA-certified carpet cleaning technicians spans the entire
        ...
        <div className="max-w-[1400px] mx-auto px-6">
          ...
          >
            ...
            <p className="text-base lg:text-lg text-[var(--muted-foreground)] leading-relaxed">
              We&rsquo;re a local specialist, not an impersonal national agency. Our NCCA-certified
        ...
        <div className="max-w-[1400px] mx-auto px-6">
          ...
          >
            ...
            <p className="text-base lg:text-lg text-[var(--muted-foreground)] leading-relaxed max-w-2xl mx-auto">
              ...
              Tell us about your carpets and rugs, get matched with a local NCCA-certified
      ...
      <section className="py-16 lg:py-24 bg-background">
        <div className="max-w-[1400px] mx-auto px-6">
          ...
          >
            ...
            <p className="text-base lg:text-lg text-[var(--muted-foreground)] leading-relaxed">
              Our carpet &amp; rug deep cleaning is the perfect reset to combine with our other
              specialist services. Restore the pile today, then keep it pristine with the right
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              },
              {
                ...
                description:
                  "Moving homes? Our End of Tenancy Cleaning includes a Deposit-Back Guarantee and professional carpet extraction as standard. We work to the letting agent&rsquo;s inventory and come back free of charge if anything is flagged.",
              ...
              },
              {
                ...
                description:
                  "If you&rsquo;re putting a house up for sale, a Deep House Cleaning combined with rug rejuvenation creates the WOW factor that attracts buyers and lifts offers. Stale odours and tired carpets are the single biggest turn-off at viewings.",
              ...
              },
              {
                ...
                description:
                  "Book a One-Off Spring Clean for a comprehensive top-to-bottom refresh of your entire home &mdash; skirtings, light fittings, behind appliances, and the carpet extraction that pulls a winter&rsquo;s worth of grit from the pile.",
        ...
        <div className="relative max-w-[1100px] mx-auto px-6 text-center">
          ...
          >
            ...
            <p className="text-base lg:text-lg text-white/80 leading-relaxed max-w-2xl mx-auto mb-8">
              ...
              no waiting 24 hours for a callback. NCCA &amp; WoolSafe certified technicians, child
              &amp; pet-safe products, a 100% re-clean guarantee, and a written aftercare card with
              every visit &mdash; from £18/room. Coverage across 72+ Scottish towns.
            </p>
      ...
      <section className="py-16 lg:py-24 bg-background">
        <div className="max-w-4xl mx-auto px-6">
          ...
          >
            <span className="text-xs font-bold uppercase tracking-[0.18em] text-[var(--brand)] mb-3 inline-block">
              Carpet &amp; rug cleaning near me · FAQ
            </span>
            <h2 className="font-display font-extrabold text-3xl lg:text-5xl text-[var(--ink)] tracking-tight mb-4">
