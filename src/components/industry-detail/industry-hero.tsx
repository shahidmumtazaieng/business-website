    ...
    <section className="relative overflow-hidden bg-mesh pt-8 lg:pt-12 pb-16 lg:pb-24">
      ...
      <div className="max-w-[1400px] mx-auto px-6 relative">
        ...
        <motion.nav
          ...
          className="flex items-center gap-1.5 text-xs text-[var(--muted-foreground)] mb-6 flex-wrap"
        >
          <a href="/" className="hover:text-[var(--brand)] transition-colors">Home</a>
          <ChevronRight className="w-3 h-3" />
          <a href="#" className="hover:text-[var(--brand)] transition-colors">Industries</a>
          <ChevronRight className="w-3 h-3" />
          <a href="#" className="hover:text-[var(--brand)] transition-colors">{industry.category}</a>
          <ChevronRight className="w-3 h-3" />
          <span className="text-[var(--ink)] font-semibold">{industry.name}</span>
        </motion.nav>
        ...
        <div className="grid lg:grid-cols-[1.1fr_1fr] gap-12 items-center">
          ...
          >
            ...
            >
              ...
              {industry.category} · Site audit within 48 hours
            </motion.div>
            ...
            >
              ...
              <div className="flex items-center gap-1.5 text-[var(--muted-foreground)]">
                <Clock className="w-4 h-4 text-[var(--brand)]" /> 24/7 cover available
              </div>
            </motion.div>
          </motion.div>
          ...
          >
              ...
              <div className="absolute inset-0 p-6 flex flex-col">
                <div className="flex items-center justify-between text-white">
                  <div className="flex items-center gap-2">
                    ...
                    <div className="text-xs">
                      <div className="font-semibold">Sector Specialist</div>
                ...
                >
                  <div className="flex items-center justify-between mb-3">
                    <div className="text-sm font-bold text-[var(--ink)]">Sector credentials</div>
                  ...
                  <div className="grid grid-cols-3 gap-2 text-center">
                    {industry.stats.slice(0, 3).map((stat) => (
                      <div key={stat.label} className="bg-[var(--cream)] rounded-lg p-2">
                        <div className="text-sm font-bold text-gradient-brand">{stat.value}</div>
                        <div className="text-[10px] text-[var(--muted-foreground)] leading-tight mt-0.5">{stat.label}</div>
                      </div>
                    ))}
                  </div>
                </motion.div>
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <div>
                  <div className="text-[10px] text-[var(--muted-foreground)]">Compliance</div>
                  <div className="text-xs font-bold text-[var(--ink)]">{industry.compliance.length} standards</div>
                </div>
              </div>
            </motion.div>
